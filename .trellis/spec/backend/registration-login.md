...
- If `common.PasswordLoginEnabled` is true, a completed registration attempts session creation with `login_method=password`. No second password-login request or repeated Turnstile challenge is needed.
