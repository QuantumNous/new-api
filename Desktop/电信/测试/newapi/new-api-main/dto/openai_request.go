...
type GeneralOpenAIRequest struct {
	...
	ImageConfig json.RawMessage `json:"image_config,omitempty"` // OpenRouter Gemini image generation
	//xai
...
type Message struct {
	...
	Images           json.RawMessage `json:"images,omitempty"` // OpenRouter Gemini image generation response
