...
// The classic frontend is the only supported frontend. The old "default"
// value is accepted as an upgrade compatibility alias and normalized here.
func SetTheme(t string) {
	if t == "" || t == "default" || t == "classic" {
		themeValue.Store("classic")
	}
}

// ThemeAwarePath is kept for compatibility with older call sites. With only
// the classic frontend available, paths are returned unchanged.
