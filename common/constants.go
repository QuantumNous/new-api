...
// Only "default", "classic", and "enterprise" are accepted; other values are silently ignored.
func SetTheme(t string) {
	if t == "default" || t == "classic" || t == "enterprise" {
		themeValue.Store(t)
	}
}
...
func IsValidateRole(role int) bool {
	return role == RoleGuestUser || role == RoleCommonUser || role == RoleOperatorAdmin || role == RoleAdminUser || role == RoleRootUser
}
