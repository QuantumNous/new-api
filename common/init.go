...
func InitEnv() {
	...
	AuthRefreshRateLimitNum = GetEnvOrDefault("AUTH_REFRESH_RATE_LIMIT", 60)
	AuthRefreshRateLimitDuration = int64(GetEnvOrDefault("AUTH_REFRESH_RATE_LIMIT_DURATION", 20*60))
