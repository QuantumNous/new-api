...
func InitEnv() {
	...
	CookieSessionDomain = GetEnvOrDefaultString("COOKIE_SESSION_DOMAIN", "")
...
func initConstantEnv() {
	...
	constant.StreamingFirstResponseTimeout = GetEnvOrDefault("STREAMING_FIRST_RESPONSE_TIMEOUT", 180)
