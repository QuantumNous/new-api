...
func ValidateRedirectURL(rawURL string) error {
	...
	if err != nil {
		return fmt.Errorf(Translate(DefaultLang, "common.invalid_url_format"), err.Error())
	}

	if parsedURL.Scheme != "http" && parsedURL.Scheme != "https" {
		return errors.New(Translate(DefaultLang, "common.invalid_url_scheme_only_http_and_https_are"))
	}
	...
	return fmt.Errorf(Translate(DefaultLang, "common.domain_is_not_in_the_trusted_domains_list"), domain)
}
