...
var auditContentTemplates = map[string]string{
	...
	"model.create_with_options": "Created model ${model_name} (ID: ${model_id}) with settings ${option_keys}",
	"model.update_with_options": "Updated model ${model_name} (ID: ${model_id}) with settings ${option_keys}",
