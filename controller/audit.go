...
var auditContentTemplates = map[string]string{
	...
	"channel.lab_balance_sync":   "Synced balances for Lab group ${group_slug} (${count} channels)",
	"channel.lab_model_test":     "Tested models for Lab group ${group_slug} (${count} channels)",
	"channel.lab_delete":         "Deleted Lab group ${group_slug} (${count} channels)",
