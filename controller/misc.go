...
func SendEmailVerification(c *gin.Context) {
	...
	content := fmt.Sprintf("<p>Hello,</p>"+
		...
		"<p>This code expires in %d minutes. If you did not request this, please ignore this email.</p>", common.SystemName, code, common.VerificationValidMinutes)
...
func SendPasswordResetEmail(c *gin.Context) {
	...
	if model.IsEmailAlreadyTaken(email) {
		...
		content := fmt.Sprintf("<p>Hello,</p>"+
			...
			"<p>This link expires in %d minutes. If you did not request this, please ignore this email.</p>", common.SystemName, link, link, common.VerificationValidMinutes)
		err := common.SendEmail(subject, email, content)
		if err != nil {
