...
func FetchUpstreamRatios(c *gin.Context) {
	...
	if err := c.ShouldBindJSON(&req); err != nil {
		common.SysError(i18n.Translate(i18n.DefaultLang, "ctrl.failed_to_bind_upstream_request") + err.Error())
...
func convertOpenRouterToRatioData(reader io.Reader) (map[string]any, error) {
	...
	if err := common.DecodeJson(reader, &orResp); err != nil {
		return nil, fmt.Errorf(i18n.Translate(i18n.DefaultLang, "ctrl.failed_to_decode_openrouter_response"), err)
	}
...
func convertModelsDevToRatioData(reader io.Reader) (map[string]any, error) {
	...
	if err := common.DecodeJson(reader, &upstreamData); err != nil {
		return nil, fmt.Errorf(i18n.Translate(i18n.DefaultLang, "ctrl.failed_to_decode_models_dev_response"), err)
	}
	if len(upstreamData) == 0 {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "ctrl.empty_models_dev_response"))
	}
	...
	if len(selectedCandidates) == 0 {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "ctrl.no_valid_models_dev_pricing_entries_found"))
	}
