...
func RequestWaffoPancakeAmount(c *gin.Context) {
	...
	if req.Amount < int64(setting.WaffoPancakeMinTopUp) {
		paymentDataErrorI18n(c, i18n.MsgTopupAmountMin, map[string]any{"Amount": setting.WaffoPancakeMinTopUp})
		return
	}
...
func RequestWaffoPancakePay(c *gin.Context) {
	if !setting.WaffoPancakeEnabled {
		paymentDataErrorI18n(c, i18n.MsgPaymentDisabled)
		return
	}
	...
	if strings.TrimSpace(setting.WaffoPancakeMerchantID) == "" ||
		...
		paymentDataErrorI18n(c, i18n.MsgPaymentConfigIncomplete)
		return
	}
	...
	if err != nil || user == nil {
		paymentDataErrorI18n(c, i18n.MsgUserNotExists)
		return
	}
