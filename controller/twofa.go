...
func Setup2FA(c *gin.Context) {
	...
	common.ApiSuccessI18n(c, i18n.MsgTwoFASetupInitSuccess, Setup2FAResponse{
		Secret:      key.Secret(),
...
func Enable2FA(c *gin.Context) {
	...
	if twoFA == nil {
		common.ApiErrorI18n(c, i18n.MsgTwoFANeedSetup)
		return
	}
	if twoFA.IsEnabled {
		common.ApiErrorI18n(c, i18n.MsgTwoFAAlreadyEnabled)
...
func RegenerateBackupCodes(c *gin.Context) {
	...
	backupCodes, err := common.GenerateBackupCodes()
	if err != nil {
		common.ApiErrorI18n(c, i18n.MsgTwoFAGenerateBackupFailed)
		common.SysLog("生成备用码失败: " + err.Error())
		return
	}
	...
	// 保存新的备用码
	if err := model.CreateBackupCodes(userId, backupCodes); err != nil {
		common.ApiErrorI18n(c, i18n.MsgTwoFASaveBackupFailed)
		common.SysLog("保存备用码失败: " + err.Error())
		return
	}
	...
	common.ApiSuccessI18n(c, i18n.MsgTwoFARegenerateSuccess, map[string]interface{}{
...
func Verify2FALogin(c *gin.Context) {
	...
	user, err := model.GetUserById(userId, false)
	if err != nil {
		common.ApiErrorI18n(c, i18n.MsgTwoFAUserNotFound)
		return
	}
...
func AdminDisable2FA(c *gin.Context) {
	...
	if myRole <= targetUser.Role && myRole != common.RoleRootUser {
		common.ApiErrorI18n(c, i18n.MsgTwoFAForbidden)
		return
	}
