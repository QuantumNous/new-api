...
test("boot splash shows the BoxAI star, not the sparkle glyph", async ({ page }) => {
  ...
  await expect(page.getByText(/Starting BoxAI Desktop|Restoring your session/)).toBeVisible();
});
