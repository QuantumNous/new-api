              ...
              <div>
                ...
                {connected.length > 0 && (
                  <p className="text-[10.5px] text-faint mt-1 leading-snug">
                    {t("Off mutes it for")} <b>{t("this session only")}</b> {t("— the connector stays connected.")}
                  </p>
                )}
  ...
  return (
    <div>
      ...
      <p className="text-[10.5px] text-faint mt-2 leading-snug">
        {t("Connecting makes")} {c.title} {t("available to all your coworkers — the toggle in this list controls just this session.")}
      </p>
    </div>
  );
}
...
function ChannelsInline({
  ...
  return (
    <div>
      ...
      {channels.length === 0 ? (
        <div className="text-[12px] text-faint py-0.5">
          {t("Not listening to any")} {label} {t("channel yet.")}
        </div>
      ) : (
        <div className="space-y-1">
          {channels.map((s) => (
