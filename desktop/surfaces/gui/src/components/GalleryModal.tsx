            ...
            <div className={CARD + " p-5 flex items-center gap-4"} data-testid="gallery-signin">
              <div className="min-w-0 flex-1">
                ...
                <div className="text-[12.5px] text-muted leading-relaxed">
                  {t("The Gallery is a curated set of coworkers from BoxAI and needs a (free) cloud sign-in. Installing personas from a folder or Git URL — on the Personas page — always works without an account.")}
                </div>
              </div>
