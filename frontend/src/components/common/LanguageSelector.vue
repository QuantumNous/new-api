<template>
  <div ref="root" class="relative" data-hero-canvas-boundary>
    <button
      ...
      :class="
        variant === 'console'
          ? 'flex h-11 w-11 items-center justify-center gap-1.5 rounded-full font-medium hover:bg-[var(--state-hover-layer)] sm:w-auto sm:px-3.5'
            ...
            :class="
              variant === 'console'
                ? loc.code === current
                  ...
                  : 'min-h-11 justify-between px-4 py-2 text-[var(--text-primary)] hover:bg-[var(--state-hover-layer)]'
                : loc.code === current
                  ? 'min-h-11 gap-2 rounded-lg px-3 py-2 bg-[var(--accent-soft)] text-[var(--text-primary)]'
                  : 'min-h-11 gap-2 rounded-lg px-3 py-2 rounded-lg text-[var(--text-secondary)] hover:bg-[var(--state-hover-layer)] hover:text-[var(--text-primary)]'
            "
