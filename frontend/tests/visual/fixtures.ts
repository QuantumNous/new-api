...
export async function configureStablePage(
  ...
  const responses = new Map<string, unknown>([
    ...
    ['/api/next/admin/tickets/summary', { pending: 2, unassigned: 1, mine: 1 }],
    [
        ...
        items: [
          {
            ...
            display_name: VISUAL_USER.display_name,
          },
          {
            id: 9,
            username: 'visual.support',
            display_name: 'Visual Support',
          },
        ],
      },
    ],
        ...
        items: [
          {
            ...
            created: Math.floor((FIXED_NOW - 2 * DAY_MS) / 1000),
            updated: Math.floor((FIXED_NOW - DAY_MS) / 1000),
            assignee_id: VISUAL_USER.id,
            assignee_name: VISUAL_USER.display_name,
            assigned_at: Math.floor((FIXED_NOW - DAY_MS) / 1000),
            user: {
              id: 8,
              username: 'visual.requester',
              display_name: 'Visual Requester',
            },
          },
          {
            id: 2,
            title: 'Billing quota follow-up',
            category: 'billing',
            priority: 'high',
            status: 'open',
            reply_count: 1,
            ...
            created: Math.floor((FIXED_NOW - 3 * DAY_MS) / 1000),
            updated: Math.floor((FIXED_NOW - 3 * 3_600_000) / 1000),
            assignee_id: null,
            assigned_at: 0,
            user: {
              id: 8,
