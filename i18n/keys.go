...
const (
	...
	MsgUserEmailOnlyLoginDisabled    = "user.email_only_login_disabled"
	MsgEmailLoginCodeSent            = "user.email_login_code_sent"
	MsgEmailLoginCodeInvalid         = "user.email_login_code_invalid"
	MsgEmailLoginCodeExpired         = "user.email_login_code_expired"
	MsgEmailLoginCodeRateLimited     = "user.email_login_code_rate_limited"
	MsgEmailLoginCodeTooManyAttempts = "user.email_login_code_too_many_attempts"
