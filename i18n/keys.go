...
const (
	...
	MsgPasskeyDeleteFailed               = "passkey.delete_failed"
	...
	MsgPasskeyMethodVerificationRequired = "passkey.method_verification_required"
)
...
const (
	...
	MsgTwoFABackupCodeGenerateFailed = "twofa.backup_code_generate_failed"
	MsgTwoFABackupCodeSaveFailed     = "twofa.backup_code_save_failed"
	MsgTwoFASetupInitialized         = "twofa.setup_initialized"
	...
	MsgTwoFAUserIdFormatError        = "twofa.user_id_format_error"
	MsgTwoFANoPermissionManage       = "twofa.no_permission_manage"
	MsgTwoFAAdminDisabled            = "twofa.admin_disabled"
	MsgTwoFACodeMustBeSixDigits      = "twofa.code_must_be_six_digits"
	MsgTwoFACodeMustBeNumeric        = "twofa.code_must_be_numeric"
	MsgTwoFALockedUntil              = "twofa.locked_until"
)

// Secure verification messages
const (
	MsgSecureNotLoggedIn              = "secure.not_logged_in"
	MsgSecureInvalidParams            = "secure.invalid_params"
	MsgSecureUserInfoFailed           = "secure.user_info_failed"
	MsgSecureNoMethodEnabled          = "secure.no_method_enabled"
	MsgSecureTwoFANotEnabled          = "secure.twofa_not_enabled"
	MsgSecurePasskeyNotEnabled        = "secure.passkey_not_enabled"
	MsgSecureCodeRequired             = "secure.code_required"
	MsgSecurePasskeyStateInvalid      = "secure.passkey_state_invalid"
	MsgSecurePasskeyVerificationFirst = "secure.passkey_verification_first"
	MsgSecureUnsupportedMethod        = "secure.unsupported_method"
	MsgSecureVerificationFailed       = "secure.verification_failed"
	MsgSecureSaveFailed               = "secure.save_failed"
	MsgSecureSuccess                  = "secure.success"
	MsgSecureVerificationRequired     = "secure.verification_required"
