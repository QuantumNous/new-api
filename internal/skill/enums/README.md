...
| `EntryPoint` | marketplace_card, skill_detail, my_skills, saved_list, featured, popular, new, recommended, reco_personal, reco_codownload, admin_preview, search_results, skill_package, playground_picker (legacy only) | skill_usage_events.entry_point |
