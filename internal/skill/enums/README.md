...
| `EntryPoint` | marketplace_card, skill_detail, my_skills, saved_list, playground_picker, featured, popular, new, recommended, admin_preview, search_results, skill_package | skill_usage_events.entry_point |
