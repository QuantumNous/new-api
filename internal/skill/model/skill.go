...
type Skill struct {
	...
	MonetizationType  enums.MonetizationType `gorm:"column:monetization_type;type:varchar(32);not null;check:chk_skills_monetization_type,monetization_type IN ('free','plan_included','token_markup','one_time')"`
