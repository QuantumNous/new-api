...
const sueEntryPointCheckExpr = "entry_point IN ('marketplace_card','skill_detail','my_skills','saved_list','playground_picker','featured','popular','new','new_week','trending','recommended','reco_personal','reco_codownload','digest','reengage','admin_preview','search_results','skill_package','api_token','downloaded_runner')"
