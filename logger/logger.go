...
func SetupLogger() {
	...
	if *common.LogDir != "" {
		...
		if !ok {
			log.Println(common.Translate(common.DefaultLang, "logger.setup_log_is_already_working"))
			return
		}
		defer func() {
			setupLogLock.Unlock()
...
func LogJson(ctx context.Context, msg string, obj any) {
	...
	if err != nil {
		LogError(ctx, fmt.Sprintf(common.Translate(common.DefaultLang, "logger.json_marshal_failed"), err.Error()))
		return
	}
