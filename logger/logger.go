...
func LogQuota(quota int) string {
	...
	case operation_setting.QuotaDisplayTypeCNY:
		...
		return fmt.Sprintf("¥%.6f credits", cny)
	case operation_setting.QuotaDisplayTypeCustom:
		...
		v := usd * rate
		return fmt.Sprintf("%s%.6f credits", symbol, v)
	case operation_setting.QuotaDisplayTypeTokens:
		return fmt.Sprintf("%d points", quota)
	default: // USD
		return fmt.Sprintf("$%.6f credits", q/common.QuotaPerUnit)
	}
}
