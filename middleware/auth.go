...
func TokenAuth() func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		if len(allowIps) > 0 {
			clientIp := c.ClientIP()
			logger.LogDebug(c, i18n.Translate(i18n.DefaultLang, "mw.token_has_ip_restrictions_checking_client_ip"), clientIp)
			...
			logger.LogDebug(c, i18n.Translate(i18n.DefaultLang, "mw.client_ip_passed_the_token_ip_restrictions_check"), clientIp)
		}
...
func SetupContextForToken(c *gin.Context, token *model.Token, parts ...string) error {
	if token == nil {
		return errors.New(i18n.Translate(i18n.DefaultLang, "mw.token_is_nil"))
	}
	c.Set("id", token.UserId)
	c.Set("token_id", token.Id)
	c.Set("token_key", token.Key)
