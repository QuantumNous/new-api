	...
	return func(c *gin.Context) {
		...
		if userId == 0 {
			c.JSON(http.StatusUnauthorized, gin.H{
				"success": false,
				"message": common.TranslateMessage(c, i18n.MsgSecureNotLoggedIn),
			})
			c.Abort()
			return
		}
		...
		if !ok {
			...
			c.JSON(http.StatusForbidden, gin.H{
				"success": false,
				"message": common.TranslateMessage(c, i18n.MsgSecureVerificationInvalid),
		...
		if elapsed >= SecureVerificationTimeout {
			...
			c.JSON(http.StatusForbidden, gin.H{
				"success": false,
				"message": common.TranslateMessage(c, i18n.MsgSecureVerificationExpired),
