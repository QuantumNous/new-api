...
func GetRandomSatisfiedChannelWithExclusions(group string, model string, retry int, requestPath string, excluded map[int]bool) (*Channel, error) {
	...
	if len(channels) == 1 {
		if excluded != nil && excluded[channels[0]] {
			return nil, nil
		}
