...
func UserCheckin(userId int) (*Checkin, error) {
	...
	if !setting.Enabled {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "checkin.not_enabled_model"))
	}
	...
	if hasChecked {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "checkin.already_done_model"))
	}
...
func userCheckinWithTransaction(checkin *Checkin, userId int, quotaAwarded int) (*Checkin, error) {
	err := DB.Transaction(func(tx *gorm.DB) error {
		...
		if err := tx.Create(checkin).Error; err != nil {
			return errors.New(i18n.Translate(i18n.DefaultLang, "checkin.failed_model"))
		}

		// 步骤2: 在事务中增加用户额度
		if err := tx.Model(&User{}).Where("id = ?", userId).
			Update("quota", gorm.Expr("quota + ?", quotaAwarded)).Error; err != nil {
			return errors.New(i18n.Translate(i18n.DefaultLang, "checkin.quota_error_model"))
		}
...
func userCheckinWithoutTransaction(checkin *Checkin, userId int, quotaAwarded int) (*Checkin, error) {
	...
	if err := DB.Create(checkin).Error; err != nil {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "checkin.failed_model"))
	}
	...
	if err := IncreaseUserQuota(userId, quotaAwarded, true); err != nil {
		// 如果增加额度失败，需要回滚签到记录
		DB.Delete(checkin)
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "checkin.quota_error_model"))
	}
