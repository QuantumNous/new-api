...
type Log struct {
	Id                int    `json:"id" gorm:"index:idx_created_at_id,priority:2;index:idx_user_id_id,priority:2;index:idx_logs_channel_type_created_id,priority:4;index:idx_logs_user_type_created_id,priority:4"`
	UserId            int    `json:"user_id" gorm:"index;index:idx_user_id_id,priority:1;index:idx_logs_user_type_created_id,priority:1"`
	CreatedAt         int64  `json:"created_at" gorm:"bigint;index:idx_created_at_id,priority:1;index:idx_created_at_type;index:idx_type_created_at_quota,priority:2;index:idx_logs_channel_type_created_id,priority:3;index:idx_logs_user_type_created_id,priority:3"`
	Type              int    `json:"type" gorm:"index:idx_created_at_type;index:idx_type_created_at_quota,priority:1;index:idx_logs_channel_type_created_id,priority:2;index:idx_logs_user_type_created_id,priority:2"`
