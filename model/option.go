...
func InitOptionMap() {
	...
	common.OptionMap["UpstreamQuotaErrorKeywords"] = operation_setting.UpstreamQuotaErrorKeywordsToString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "UpstreamQuotaErrorKeywords":
		operation_setting.UpstreamQuotaErrorKeywordsFromString(value)
