...
func InitOptionMap() {
	...
	common.OptionMap["FingerprintAutoDisableEnabled"] = strconv.FormatBool(common.FingerprintAutoDisableEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "FingerprintAutoDisableEnabled":
			common.FingerprintAutoDisableEnabled = boolValue
