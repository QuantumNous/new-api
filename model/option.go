...
func InitOptionMap() {
	...
	common.OptionMap["TaskBillingUnit"] = ratio_setting.EffectiveTaskBillingUnit2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "TaskBillingUnit":
		err = ratio_setting.UpdateTaskBillingUnitByJSONString(value)
		if err == nil {
			common.OptionMap["TaskBillingUnit"] = ratio_setting.EffectiveTaskBillingUnit2JSONString()
		}
	case "CacheRatio":
