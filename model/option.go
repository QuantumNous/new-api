...
func InitOptionMap() {
	...
	common.OptionMap["AudioCacheRatio"] = ratio_setting.AudioCacheRatio2JSONString()
	common.OptionMap["ImageCacheRatio"] = ratio_setting.ImageCacheRatio2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "AudioCacheRatio":
		err = ratio_setting.UpdateAudioCacheRatioByJSONString(value)
	case "ImageCacheRatio":
		err = ratio_setting.UpdateImageCacheRatioByJSONString(value)
