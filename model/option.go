...
func InitOptionMap() {
	...
	common.OptionMap["SensitiveCheckRules"] = setting.SensitiveCheckRulesToString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "SensitiveCheckRules":
		err = setting.SensitiveCheckRulesFromString(value)
...
func handleConfigUpdate(key, value string) bool {
	...
	if configName == "performance_setting" {
		...
		operation_setting.NormalizePaymentSetting()
