...
func InitOptionMap() {
	...
	common.OptionMap["SubscriptionBalancePayEnabled"] = strconv.FormatBool(operation_setting.SubscriptionBalancePayEnabled)
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" {
		...
		case "SubscriptionBalancePayEnabled":
			operation_setting.SubscriptionBalancePayEnabled = boolValue
