...
var (
	...
	ErrFriendlyPasskeyNotFound = errors.New("passkey verification failed")
	ErrPasskeySaveFailed       = errors.New("passkey save failed")
	ErrPasskeyDeleteFailed     = errors.New("passkey delete failed")
)
