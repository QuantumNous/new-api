...
type Pricing struct {
	...
	ImageGeneration        *model_setting.ImageGenerationCapabilities `json:"image_generation,omitempty"`
}
...
func updatePricing() {
	...
	for model, groups := range modelGroupsMap {
		pricing := Pricing{
			...
			ImageGeneration:        model_setting.GetImageGenerationCapabilities(model),
		}
	...
	// 防止大更新后数据不通用
	if len(pricingMap) > 0 {
		pricingMap[0].PricingVersion = "c93f4990684023eef6ec35670795311442418348207af6cd284468468f812f69"
	}
