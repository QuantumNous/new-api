...
func TestAdminBindSubscriptionRenewExtendsWithoutConsumingLimit(t *testing.T) {
	...
	_, err = AdminBindSubscription(101, plan.Id, AdminGrantOptions{Mode: SubscriptionGrantRenew})
	require.NoError(t, err)
...
func TestAdminBindSubscriptionReplaceCancelsExisting(t *testing.T) {
	...
	_, err = AdminBindSubscription(101, plan.Id, AdminGrantOptions{Mode: SubscriptionGrantReplace})
	require.NoError(t, err)
...
func TestAdminBindSubscriptionHonoursCustomEndTime(t *testing.T) {
	...
	_, err := AdminBindSubscription(101, plan.Id, AdminGrantOptions{EndTime: customEnd})
	require.NoError(t, err)
	...
	_, err = AdminBindSubscription(101, plan.Id, AdminGrantOptions{EndTime: GetDBTimestamp() - 60})
	require.Error(t, err)
}
...
func TestAdminBindSubscriptionBatchReportsPerUserFailures(t *testing.T) {
	...
	result, err := AdminBindSubscriptionBatch([]int{101, 102, 999}, plan.Id, AdminGrantOptions{})
	require.NoError(t, err)
