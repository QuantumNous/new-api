...
type TaskBillingContext struct {
	...
	UpstreamCostMultiplier   float64 `json:"upstream_cost_multiplier,omitempty"`    // 上游 data.cost 结算乘数（提交时快照）
}
...
func (t *Task) Snapshot() taskSnapshot {
	return taskSnapshot{
		...
		RetryCount:     t.PrivateData.RetryCount,
	}
}
