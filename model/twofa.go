...
func GetTwoFAByUserId(userId int) (*TwoFA, error) {
	if userId == 0 {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "twofa.user_id_cannot_be_empty"))
	}
...
func (t *TwoFA) Create() error {
	...
	if existing != nil {
		return errors.New(i18n.Translate(i18n.DefaultLang, "twofa.already_configured"))
	}
	...
	if err := DB.First(&user, t.UserId).Error; err != nil {
		if errors.Is(err, gorm.ErrRecordNotFound) {
			return errors.New(i18n.Translate(i18n.DefaultLang, "twofa.user_not_found"))
		}
		return err
	}
...
func (t *TwoFA) Update() error {
	if t.Id == 0 {
		return errors.New(i18n.Translate(i18n.DefaultLang, "twofa.record_id_cannot_be_empty"))
	}
...
func ValidateBackupCode(userId int, code string) (bool, error) {
	if !common.ValidateBackupCode(code) {
		return false, errors.New(i18n.Translate(i18n.DefaultLang, "twofa.invalid_code_or_backup"))
	}
...
func (t *TwoFA) ValidateTOTPAndUpdateUsage(code string) (bool, error) {
	// 检查是否被锁定
	if t.IsLocked() {
		return false, errors.New(i18n.Translate(i18n.DefaultLang, "twofa.account_locked_model", map[string]any{"Time": t.LockedUntil.Format("2006-01-02 15:04:05")}))
	}
	...
	if !common.ValidateTOTPCode(t.Secret, code) {
		...
		if err := t.IncrementFailedAttempts(); err != nil {
			common.SysLog(i18n.Translate(i18n.DefaultLang, "log.twofa_update_attempt_failed", map[string]any{"Error": err}))
		}
		return false, nil
	}
	...
	if err := t.Update(); err != nil {
		common.SysLog(i18n.Translate(i18n.DefaultLang, "model.failed_to_update_2fa_usage_record") + err.Error())
	}
