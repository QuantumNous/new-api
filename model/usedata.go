...
func UpdateQuotaData() {
	for {
		if common.DataExportEnabled {
			common.SysLog(i18n.Translate(i18n.DefaultLang, "model.updating_dashboard_data"))
			SaveQuotaDataCache()
		}
...
func SaveQuotaDataCache() {
	...
	common.SysLog(fmt.Sprintf(i18n.Translate(i18n.DefaultLang, "model.dashboard_data_saved_successfully_records_saved"), size))
}
...
func increaseQuotaData(userId int, username string, modelName string, count int, quota int, createdAt int64, tokenUsed int) {
	...
	if err != nil {
		common.SysLog(fmt.Sprintf(i18n.Translate(i18n.DefaultLang, "model.increasequotadata_error"), err))
	}
}
