...
type User struct {
	...
	BoundAgentId         int                        `json:"bound_agent_id" gorm:"type:int;default:0;column:bound_agent_id;index"`
	BoundAt              int64                      `json:"bound_at" gorm:"type:bigint;default:0;column:bound_at;index"`
