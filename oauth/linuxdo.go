...
func (p *LinuxDOProvider) ExchangeToken(ctx context.Context, code string, c *gin.Context) (*OAuthToken, error) {
	...
	logger.LogDebug(ctx, i18n.Translate(i18n.DefaultLang, "oauth.oauth_linuxdo_exchangetoken_code"), code[:min(len(code), 10)])
	...
	logger.LogDebug(ctx, i18n.Translate(i18n.DefaultLang, "oauth.oauth_linuxdo_exchangetoken_token_endpoint_redirect_uri"), tokenEndpoint, redirectURI)
	...
	if err != nil {
		logger.LogError(ctx, fmt.Sprintf(i18n.Translate(i18n.DefaultLang, "oauth.oauth_linuxdo_exchangetoken_error"), err.Error()))
		return nil, NewOAuthErrorWithRaw("oauth.connect_failed", map[string]any{"Provider": "Linux DO"}, err.Error())
	}
	defer res.Body.Close()

	logger.LogDebug(ctx, i18n.Translate(i18n.DefaultLang, "oauth.oauth_linuxdo_exchangetoken_response_status"), res.StatusCode)
	...
	if err := json.NewDecoder(res.Body).Decode(&tokenRes); err != nil {
		logger.LogError(ctx, fmt.Sprintf(i18n.Translate(i18n.DefaultLang, "oauth.oauth_linuxdo_exchangetoken_decode_error"), err.Error()))
		return nil, err
	}

	if tokenRes.AccessToken == "" {
		logger.LogError(ctx, fmt.Sprintf(i18n.Translate(i18n.DefaultLang, "oauth.oauth_linuxdo_exchangetoken_failed"), tokenRes.Message))
		return nil, NewOAuthErrorWithRaw("oauth.token_failed", map[string]any{"Provider": "Linux DO"}, tokenRes.Message)
	}

	logger.LogDebug(ctx, i18n.Translate(i18n.DefaultLang, "oauth.oauth_linuxdo_exchangetoken_success"))
...
func (p *LinuxDOProvider) GetUserInfo(ctx context.Context, token *OAuthToken) (*OAuthUser, error) {
	...
	logger.LogDebug(ctx, i18n.Translate(i18n.DefaultLang, "oauth.oauth_linuxdo_getuserinfo_user_endpoint"), userEndpoint)
	...
	res, err := client.Do(req)
	if err != nil {
		logger.LogError(ctx, fmt.Sprintf(i18n.Translate(i18n.DefaultLang, "oauth.oauth_linuxdo_getuserinfo_error"), err.Error()))
		return nil, NewOAuthErrorWithRaw("oauth.connect_failed", map[string]any{"Provider": "Linux DO"}, err.Error())
	}
	defer res.Body.Close()

	logger.LogDebug(ctx, i18n.Translate(i18n.DefaultLang, "oauth.oauth_linuxdo_getuserinfo_response_status"), res.StatusCode)

	var linuxdoUser linuxdoUser
	if err := json.NewDecoder(res.Body).Decode(&linuxdoUser); err != nil {
		logger.LogError(ctx, fmt.Sprintf(i18n.Translate(i18n.DefaultLang, "oauth.oauth_linuxdo_getuserinfo_decode_error"), err.Error()))
		return nil, err
	}

	if linuxdoUser.Id == 0 {
		logger.LogError(ctx, i18n.Translate(i18n.DefaultLang, "oauth.oauth_linuxdo_getuserinfo_failed_invalid_user_id"))
		return nil, NewOAuthError("oauth.user_info_empty", map[string]any{"Provider": "Linux DO"})
	}

	logger.LogDebug(ctx, i18n.Translate(i18n.DefaultLang, "oauth.oauth_linuxdo_getuserinfo_id_username_name_trust_level"),
	...
	if linuxdoUser.TrustLevel < common.LinuxDOMinimumTrustLevel {
		logger.LogWarn(ctx, fmt.Sprintf(i18n.Translate(i18n.DefaultLang, "oauth.oauth_linuxdo_getuserinfo_trust_level_too_low"),
	...
	logger.LogDebug(ctx, i18n.Translate(i18n.DefaultLang, "oauth.oauth_linuxdo_getuserinfo_success_id_username"), linuxdoUser.Id, linuxdoUser.Username)
