			...
			for i2, mediaMessage := range content {
				if mediaMessage.Source != nil {
					if mediaMessage.Source.Type == "url" {
						...
						if err != nil {
							return nil, fmt.Errorf(i18n.Translate(i18n.DefaultLang, "relay.get_file_base64_from_url_failed"), err.Error())
						}
...
func (a *Adaptor) GetRequestURL(info *relaycommon.RelayInfo) (string, error) {
	if info.ChannelOtherSettings.AwsKeyType == dto.AwsKeyTypeApiKey {
		...
		if len(awsSecret) != 2 {
			return "", errors.New(i18n.Translate(i18n.DefaultLang, "relay.invalid_aws_api_key_should_be_in_format"))
		}
