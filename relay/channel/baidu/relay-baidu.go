...
func baiduStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*types.NewAPIError, *dto.Usage) {
	...
	helper.StreamScannerHandler(c, resp, info, func(data string) bool {
		...
		if err != nil {
			common.SysLog(i18n.Translate(i18n.DefaultLang, "relay.error_sending_stream_response") + err.Error())
		}
		return true
	})
...
func getBaiduAccessToken(apiKey string) (string, error) {
	...
	if accessToken == nil {
		return "", errors.New(i18n.Translate(i18n.DefaultLang, "relay.getbaiduaccesstoken_return_a_nil_token"))
	}
	return (*accessToken).AccessToken, nil
}
...
func getBaiduAccessTokenHelper(apiKey string) (*BaiduAccessToken, error) {
	...
	if len(parts) != 2 {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.invalid_baidu_apikey"))
	}
	...
	if accessToken.AccessToken == "" {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.getbaiduaccesstokenhelper_get_empty_access_token"))
	}
