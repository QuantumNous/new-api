...
func uploadDifyFile(c *gin.Context, info *relaycommon.RelayInfo, user string, media dto.MediaContent) *DifyFile {
	...
	case dto.ContentTypeImageURL:
		...
		if err != nil {
			common.SysLog(i18n.Translate(i18n.DefaultLang, "relay.failed_to_decode_base64") + err.Error())
			return nil
		}
		...
		if err != nil {
			common.SysLog(i18n.Translate(i18n.DefaultLang, "relay.failed_to_create_temp_file") + err.Error())
			return nil
		}
		...
		if _, err := tempFile.Write(decodedData); err != nil {
			common.SysLog(i18n.Translate(i18n.DefaultLang, "relay.failed_to_write_to_temp_file") + err.Error())
			return nil
		}
		...
		if err := writer.WriteField("user", user); err != nil {
			common.SysLog(i18n.Translate(i18n.DefaultLang, "relay.failed_to_add_user_field") + err.Error())
			return nil
		}
		...
		// Create form file
		part, err := writer.CreateFormFile("file", fmt.Sprintf(i18n.Translate(i18n.DefaultLang, "relay.image"), strings.TrimPrefix(mimeType, "image/")))
		if err != nil {
			common.SysLog(i18n.Translate(i18n.DefaultLang, "relay.failed_to_create_form_file") + err.Error())
			return nil
		}

		// Copy file content to form
		if _, err = io.Copy(part, bytes.NewReader(decodedData)); err != nil {
			common.SysLog(i18n.Translate(i18n.DefaultLang, "relay.failed_to_copy_file_content") + err.Error())
			return nil
		}
		writer.Close()
		...
		if err != nil {
			common.SysLog(i18n.Translate(i18n.DefaultLang, "relay.failed_to_create_request") + err.Error())
			return nil
		}
		...
		if err != nil {
			common.SysLog(i18n.Translate(i18n.DefaultLang, "relay.failed_to_send_request") + err.Error())
			return nil
		}
		...
		if err := json.NewDecoder(resp.Body).Decode(&result); err != nil {
			common.SysLog(i18n.Translate(i18n.DefaultLang, "relay.failed_to_decode_response") + err.Error())
			return nil
		}
...
func requestOpenAI2Dify(c *gin.Context, info *relaycommon.RelayInfo, request dto.GeneralOpenAIRequest) *DifyChatRequest {
	...
	if err != nil {
		common.SysLog(i18n.Translate(i18n.DefaultLang, "relay.failed_to_unmarshal_user") + err.Error())
...
func difyStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.NewAPIError) {
	...
	helper.StreamScannerHandler(c, resp, info, func(data string) bool {
		...
		if err != nil {
			common.SysLog(i18n.Translate(i18n.DefaultLang, "relay.error_unmarshalling_stream_response") + err.Error())
			return true
		}
