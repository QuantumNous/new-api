...
var ModelList = []string{
	...
	"gemini-3-pro-image-preview", "gemini-3-pro-image", "nano-banana-2", "nano-banana-pro-preview",
	"gemini-3.1-flash-image-preview", "gemini-3.1-flash-image", "gemini-3.1-flash-lite-image", "gemini-robotics-er-1.5-preview",
