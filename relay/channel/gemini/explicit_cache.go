...
func prepareExplicitCache(c *gin.Context, info *relaycommon.RelayInfo, request *dto.GeminiChatRequest) {
	...
	service.UpdateGeminiCacheDiagnostics(c, map[string]any{
		"explicit_prefix_tokens":          prefixTokens,
		"explicit_prefix_hash":            prefixHash[:16],
		"explicit_cache_min_input_tokens": minTokens,
	})
