...
func ApplyThinkingAdaptationSettings(geminiRequest *GeminiChatRequest, modelName string) {
...
func CovertGemini2OpenAI(textRequest dto.GeneralOpenAIRequest, info *relaycommon.RelayInfo) (*GeminiChatRequest, error) {
	...
	// Apply thinking adaptation settings
	ApplyThinkingAdaptationSettings(&geminiRequest, info.UpstreamModelName)
