...
func SetPayloadHash(c *gin.Context, req any) error {
	...
	logger.LogInfo(c, fmt.Sprintf(i18n.Translate(i18n.DefaultLang, "relay.setpayloadhash_body"), body))
...
func Sign(c *gin.Context, req *http.Request, apiKey string) error {
	...
	if len(keyParts) != 2 {
		return errors.New(i18n.Translate(i18n.DefaultLang, "relay.invalid_api_key_format_for_jimeng_expected_ak"))
	}
