...
func handleTTSResponse(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) (usage any, err *types.NewAPIError) {
	...
	if readErr != nil {
		return nil, types.NewErrorWithStatusCode(
			fmt.Errorf(i18n.Translate(i18n.DefaultLang, "relay.failed_to_read_minimax_response"), readErr),
	...
	if unmarshalErr := json.Unmarshal(body, &minimaxResp); unmarshalErr != nil {
		return nil, types.NewErrorWithStatusCode(
			fmt.Errorf(i18n.Translate(i18n.DefaultLang, "relay.failed_to_unmarshal_minimax_tts_response"), unmarshalErr),
	...
	if minimaxResp.BaseResp.StatusCode != 0 {
		return nil, types.NewErrorWithStatusCode(
			fmt.Errorf(i18n.Translate(i18n.DefaultLang, "relay.minimax_tts_error"), minimaxResp.BaseResp.StatusCode, minimaxResp.BaseResp.StatusMsg),
	...
	if minimaxResp.Data.Audio == "" {
		return nil, types.NewErrorWithStatusCode(
			errors.New(i18n.Translate(i18n.DefaultLang, "relay.no_audio_data_in_minimax_tts_response")),
			types.ErrorCodeBadResponse,
			http.StatusBadRequest,
		)
	}
	...
	if strings.HasPrefix(minimaxResp.Data.Audio, "http") {
		...
		if decodeErr != nil {
			return nil, types.NewErrorWithStatusCode(
				fmt.Errorf(i18n.Translate(i18n.DefaultLang, "relay.failed_to_decode_hex_audio_data"), decodeErr),
				types.ErrorCodeBadResponse,
				http.StatusInternalServerError,
			)
		}
...
func handleChatCompletionResponse(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) (usage any, err *types.NewAPIError) {
	...
	if readErr != nil {
		return nil, types.NewErrorWithStatusCode(
			errors.New(i18n.Translate(i18n.DefaultLang, "relay.failed_to_read_minimax_response_2781")),
			types.ErrorCodeReadResponseBodyFailed,
			http.StatusInternalServerError,
		)
	}
