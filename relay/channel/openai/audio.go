...
func OpenaiTTSHandler(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) *dto.Usage {
	...
	if info.IsStream {
		...
		if err != nil {
			logger.LogError(c, fmt.Sprintf(i18n.Translate(i18n.DefaultLang, "relay.failed_to_read_tts_response_body"), err))
		...
		if err != nil {
			logger.LogError(c, fmt.Sprintf(i18n.Translate(i18n.DefaultLang, "relay.failed_to_write_tts_response"), err))
		}
		...
		if durationErr != nil {
			logger.LogWarn(c, fmt.Sprintf(i18n.Translate(i18n.DefaultLang, "relay.failed_to_get_audio_duration"), durationErr))
