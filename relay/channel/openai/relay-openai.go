...
// OaiStreamHandler relays OpenAI-compatible stream events and accumulates usage.
...
// OpenaiHandler converts a buffered OpenAI-compatible response and returns its usage.
