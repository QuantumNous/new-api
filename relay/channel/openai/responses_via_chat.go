...
// OaiChatToResponsesHandler converts a buffered Chat Completions result to Responses API events.
...
// OaiChatToResponsesStreamHandler converts a Chat Completions stream to Responses API events.
