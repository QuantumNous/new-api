...
// family's documented 5s Ark default must not be assumed for it. A resolution the
// shared vocabulary cannot classify is equally unpriceable, and this channel
// applies no resolution default either.
//
