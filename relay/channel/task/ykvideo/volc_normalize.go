...
// and mapped to yk-video / KYY model-center flat submit fields.
...
// body into yk-video flat fields. Returns true when normalization was applied.
func normalizeVolcOfficialInBodyMap(body map[string]interface{}, raw []byte) bool {
	...
	common.SysLog(fmt.Sprintf(
		"[yk-video] detected VolcEngine official content format; model=%s images=%d videos=%d audios=%d first_frame=%t last_frame=%t",
