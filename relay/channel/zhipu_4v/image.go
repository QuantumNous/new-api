...
func zhipu4vImageHandler(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) (*dto.Usage, *types.NewAPIError) {
	...
	for _, data := range zhipuResp.Data {
		...
		if url == "" {
			logger.LogWarn(c, i18n.Translate(i18n.DefaultLang, "relay.zhipu_image_missing_url"))
			continue
		}
		...
		if b64 == "" {
			logger.LogWarn(c, i18n.Translate(i18n.DefaultLang, "relay.zhipu_image_empty_b64"))
			continue
		}
