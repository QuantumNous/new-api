...
func TestNativeTextFormat(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "openai gpt chat defaults to responses", channelType: constant.ChannelTypeOpenAI, apiType: constant.APITypeOpenAI, model: "gpt-4o", incoming: types.RelayFormatOpenAI, want: types.RelayFormatOpenAIResponses},
		{name: "openai namespaced gpt defaults to responses", channelType: constant.ChannelTypeOpenAI, apiType: constant.APITypeOpenAI, model: "OpenAI/GPT-4.1", incoming: types.RelayFormatClaude, want: types.RelayFormatOpenAIResponses},
		{name: "openai model responses stays responses", channelType: constant.ChannelTypeOpenAI, apiType: constant.APITypeOpenAI, model: "gpt-5.6-sol", incoming: types.RelayFormatOpenAIResponses, want: types.RelayFormatOpenAIResponses},
		{name: "openai compatible glm responses converts to chat", channelType: constant.ChannelTypeOpenAI, apiType: constant.APITypeOpenAI, model: "glm-5.2", incoming: types.RelayFormatOpenAIResponses, want: types.RelayFormatOpenAI},
		...
		{name: "ollama passes through claude", channelType: constant.ChannelTypeOllama, apiType: constant.APITypeOllama, incoming: types.RelayFormatClaude, want: types.RelayFormatClaude},
		{name: "ollama passes through responses", channelType: constant.ChannelTypeOllama, apiType: constant.APITypeOllama, incoming: types.RelayFormatOpenAIResponses, want: types.RelayFormatOpenAIResponses},
		{name: "ollama converts gemini through chat", channelType: constant.ChannelTypeOllama, apiType: constant.APITypeOllama, incoming: types.RelayFormatGemini, want: types.RelayFormatOpenAI},
		{name: "ollama api type fallback passes through responses", apiType: constant.APITypeOllama, incoming: types.RelayFormatOpenAIResponses, want: types.RelayFormatOpenAIResponses},
		...
		{name: "minimax claude native", channelType: constant.ChannelTypeMiniMax, apiType: constant.APITypeMiniMax, incoming: types.RelayFormatClaude, want: types.RelayFormatClaude},
		{name: "minimax gemini via chat", channelType: constant.ChannelTypeMiniMax, apiType: constant.APITypeMiniMax, incoming: types.RelayFormatGemini, want: types.RelayFormatOpenAI},
		{name: "minimax responses via chat", channelType: constant.ChannelTypeMiniMax, apiType: constant.APITypeMiniMax, incoming: types.RelayFormatOpenAIResponses, want: types.RelayFormatOpenAI},
