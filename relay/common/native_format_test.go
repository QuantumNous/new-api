...
func TestNativeTextFormat(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "openai chat stays chat", channelType: constant.ChannelTypeOpenAI, apiType: constant.APITypeOpenAI, model: "gpt-4o", incoming: types.RelayFormatOpenAI, want: types.RelayFormatOpenAI},
