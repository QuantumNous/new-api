...
type RelayInfo struct {
	...
	IntelligentRouteLive            bool
	IntelligentRoutePolicyVersion   int
	IntelligentRouteRolloutRevision int64
	IntelligentRouteRolloutBucket   int
	IntelligentRouteRolloutMode     string
	IntelligentRouteAttempt         int
	IntelligentRouteSessionKey      string
	IntelligentRouteTask            string
