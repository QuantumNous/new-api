...
var streamSupportedChannels = map[int]bool{
	...
	constant.ChannelTypeAionly:      true,
}
...
func GenRelayInfoAionlyAudio(c *gin.Context, request dto.Request) *RelayInfo {
	info := genBaseRelayInfo(c, request)
	info.RelayFormat = types.RelayFormatAionlyAudio
	return info
}
...
func GenRelayInfo(c *gin.Context, relayFormat types.RelayFormat, request dto.Request, ws *websocket.Conn) (*RelayInfo, error) {
	...
	case types.RelayFormatAionlyAudio:
		info = GenRelayInfoAionlyAudio(c, request)
