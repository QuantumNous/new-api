...
func GenRelayInfo(c *gin.Context, relayFormat types.RelayFormat, request dto.Request, ws *websocket.Conn) (*RelayInfo, error) {
	...
	case types.RelayFormatRerank:
		...
		err = errors.New(i18n.Translate(i18n.DefaultLang, "relay.request_is_not_a_rerankrequest"))
	...
	case types.RelayFormatOpenAIResponses:
		...
		err = errors.New(i18n.Translate(i18n.DefaultLang, "relay.request_is_not_a_openairesponsesrequest"))
	case types.RelayFormatOpenAIResponsesCompaction:
		...
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.request_is_not_a_openairesponsescompactionrequest"))
	...
	case types.RelayFormatMjProxy:
		...
		info.TaskRelayInfo = &TaskRelayInfo{}
	default:
		err = errors.New(i18n.Translate(i18n.DefaultLang, "relay.invalid_relay_format"))
	}
	...
	if info == nil {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.failed_to_build_relay_info"))
	}
...
func (t *TaskSubmitReq) UnmarshalMetadata(v any) error {
	...
	if metadata != nil {
		...
		if err != nil {
			return fmt.Errorf(i18n.Translate(i18n.DefaultLang, "relay.marshal_metadata_failed"), err)
		}
		err = common.Unmarshal(metadataBytes, v)
		if err != nil {
			return fmt.Errorf(i18n.Translate(i18n.DefaultLang, "relay.unmarshal_metadata_to_target_failed"), err)
		}
	}
	return nil
}
...
func RemoveDisabledFields(jsonData []byte, channelOtherSettings dto.ChannelOtherSettings, channelPassThroughEnabled bool) ([]byte, error) {
	...
	if err := common.Unmarshal(jsonData, &data); err != nil {
		common.SysError(i18n.Translate(i18n.DefaultLang, "relay.removedisabledfields_unmarshal_error") + err.Error())
		return jsonData, nil
	}
	...
	if err != nil {
		common.SysError(i18n.Translate(i18n.DefaultLang, "relay.removedisabledfields_marshal_error") + err.Error())
		return jsonData, nil
	}
...
func RemoveGeminiDisabledFields(jsonData []byte) ([]byte, error) {
	...
	var data map[string]interface{}
	if err := common.Unmarshal(jsonData, &data); err != nil {
		common.SysError(i18n.Translate(i18n.DefaultLang, "relay.removegeminidisabledfields_unmarshal_error") + err.Error())
		return jsonData, nil
	}
	...
	jsonDataAfter, err := common.Marshal(data)
	if err != nil {
		common.SysError(i18n.Translate(i18n.DefaultLang, "relay.removegeminidisabledfields_marshal_error") + err.Error())
		return jsonData, nil
	}
	return jsonDataAfter, nil
}
