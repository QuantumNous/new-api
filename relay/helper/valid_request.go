...
func GetAndValidateRequest(c *gin.Context, format types.RelayFormat) (request dto.Request, err error) {
	...
	default:
		return nil, fmt.Errorf(i18n.Translate(i18n.DefaultLang, "relay.unsupported_relay_format"), format)
	}
	return request, err
}
...
func GetAndValidateRerankRequest(c *gin.Context) (*dto.RerankRequest, error) {
	...
	if err != nil {
		logger.LogError(c, fmt.Sprintf(i18n.Translate(i18n.DefaultLang, "relay.getandvalidatetextrequest_failed"), err.Error()))
		return nil, types.NewError(err, types.ErrorCodeInvalidRequest, types.ErrOptionWithSkipRetry())
	}

	if rerankRequest.Query == "" {
		return nil, types.NewError(errors.New(i18n.Translate(i18n.DefaultLang, "relay.query_is_empty")), types.ErrorCodeInvalidRequest, types.ErrOptionWithSkipRetry())
	}
	if len(rerankRequest.Documents) == 0 {
		return nil, types.NewError(errors.New(i18n.Translate(i18n.DefaultLang, "relay.documents_is_empty")), types.ErrorCodeInvalidRequest, types.ErrOptionWithSkipRetry())
	}
...
func GetAndValidateEmbeddingRequest(c *gin.Context, relayMode int) (*dto.EmbeddingRequest, error) {
	...
	if embeddingRequest.Input == nil {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.input_is_empty"))
	}
...
func GetAndValidateResponsesRequest(c *gin.Context) (*dto.OpenAIResponsesRequest, error) {
	...
	if request.Input == nil {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.input_is_required"))
	}
	return request, nil
}
...
func GetAndValidOpenAIImageRequest(c *gin.Context, relayMode int) (*dto.ImageRequest, error) {
	...
	case relayconstant.RelayModeImagesEdits:
		if strings.Contains(c.Request.Header.Get("Content-Type"), "multipart/form-data") {
			...
			if err != nil {
				return nil, fmt.Errorf(i18n.Translate(i18n.DefaultLang, "relay.failed_to_parse_image_edit_form_request"), err)
			}
	...
	default:
		...
		if strings.Contains(imageRequest.Size, "×") {
			return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.size_an_unexpected_error_occurred_in_the_parameter"))
		}

		// Not "256x256", "512x512", or "1024x1024"
		if imageRequest.Model == "dall-e-2" || imageRequest.Model == "dall-e" {
			if imageRequest.Size != "" && imageRequest.Size != "256x256" && imageRequest.Size != "512x512" && imageRequest.Size != "1024x1024" {
				return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.size_must_be_one_of_256x256_512x512_or"))
			}
			...
			if imageRequest.Size != "" && imageRequest.Size != "1024x1024" && imageRequest.Size != "1024x1792" && imageRequest.Size != "1792x1024" {
				return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.size_must_be_one_of_1024x1024_1024x1792_or"))
			}
			if imageRequest.Quality == "" {
				imageRequest.Quality = "standard"
			}
...
func GetAndValidateClaudeRequest(c *gin.Context) (textRequest *dto.ClaudeRequest, err error) {
	...
	if textRequest.Messages == nil || len(textRequest.Messages) == 0 {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.field_messages_is_required"))
	}
	if textRequest.Model == "" {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.field_model_is_required"))
	}
...
func GetAndValidateTextRequest(c *gin.Context, relayMode int) (*dto.GeneralOpenAIRequest, error) {
	...
	if lo.FromPtrOr(textRequest.MaxTokens, uint(0)) > math.MaxInt32/2 {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.max_tokens_is_invalid"))
	}
	if textRequest.Model == "" {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "svc.model_is_required"))
	}
	if textRequest.WebSearchOptions != nil {
		if textRequest.WebSearchOptions.SearchContextSize != "" {
			...
			if !validSizes[textRequest.WebSearchOptions.SearchContextSize] {
				return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.invalid_search_context_size_must_be_one_of"))
			}
		} else {
	...
	case relayconstant.RelayModeCompletions:
		if textRequest.Prompt == "" {
			return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.field_prompt_is_required"))
		}
	...
	case relayconstant.RelayModeModerations:
		if textRequest.Input == nil || textRequest.Input == "" {
			return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.field_input_is_required"))
		}
	case relayconstant.RelayModeEdits:
		if textRequest.Instruction == "" {
			return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.field_instruction_is_required"))
		}
	}
	return textRequest, nil
}
...
func GetAndValidateGeminiRequest(c *gin.Context) (*dto.GeminiChatRequest, error) {
	...
	if len(request.Contents) == 0 && len(request.Requests) == 0 {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "relay.contents_is_required"))
	}
