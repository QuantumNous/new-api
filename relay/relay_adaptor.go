...
import (
	...
	tasksd283zi "github.com/QuantumNous/new-api/relay/channel/task/sd283zi"
	task7tai "github.com/QuantumNous/new-api/relay/channel/task/task7tai"
	...
	taskykvideo "github.com/QuantumNous/new-api/relay/channel/task/ykvideo"
	taskyksd "github.com/QuantumNous/new-api/relay/channel/task/yksd"
...
func GetTaskAdaptor(platform constant.TaskPlatform) channel.TaskAdaptor {
	...
	if channelType, err := strconv.ParseInt(string(platform), 10, 64); err == nil {
		...
		case constant.ChannelTypeVyroSeedance:
			return &taskvyro.TaskAdaptor{}
		case constant.ChannelType83zi:
			return &tasksd283zi.TaskAdaptor{}
		case constant.ChannelType7tai:
			return &task7tai.TaskAdaptor{}
		case constant.ChannelTypeTh12345ai:
			return &taskth12345ai.TaskAdaptor{}
		...
		case constant.ChannelTypeYkVideo:
			return &taskykvideo.TaskAdaptor{}
		case constant.ChannelTypeYkSd:
			return &taskyksd.TaskAdaptor{}
		}
	}
	return nil
}
