...
func ResolveOriginTask(c *gin.Context, info *relaycommon.RelayInfo) *dto.TaskError {
	...
	if info.Action == constant.TaskActionRemix {
		...
		if strings.TrimSpace(videoID) == "" {
			return service.TaskErrorWrapperLocal(errors.New(i18n.Translate(i18n.DefaultLang, "relay.video_id_is_required")), "invalid_request", http.StatusBadRequest)
		}
	...
	if ch.Status != common.ChannelStatusEnabled {
		return service.TaskErrorWrapperLocal(errors.New(i18n.Translate(i18n.DefaultLang, "relay.the_channel_of_the_origin_task_is_disabled")), "task_channel_disable", http.StatusBadRequest)
	}
...
func RelayTaskSubmit(c *gin.Context, info *relaycommon.RelayInfo) (*TaskSubmitResult, *dto.TaskError) {
	...
	if adaptor == nil {
		return nil, service.TaskErrorWrapperLocal(fmt.Errorf(i18n.Translate(i18n.DefaultLang, "relay.invalid_api_platform"), platform), "invalid_api_platform", http.StatusBadRequest)
	}
	adaptor.Init(info)
...
func videoFetchByIDRespBodyBuilder(c *gin.Context) (respBody []byte, taskResp *dto.TaskError) {
	...
	if isOpenAIVideoAPI {
		...
		if adaptor == nil {
			taskResp = service.TaskErrorWrapperLocal(fmt.Errorf(i18n.Translate(i18n.DefaultLang, "relay.invalid_channel_id"), originTask.ChannelId), "invalid_channel_id", http.StatusBadRequest)
			return
		}
