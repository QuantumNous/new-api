...
RelayKit 是从 [new-api](https://github.com/warjiang/new-api) 中拆分出的独立 Go 模块，提供常用大模型文本协议的 DTO、请求转换、响应转换和流式事件转换。
...
```bash
go get github.com/warjiang/new-api/relaykit@latest
```
...
import (
	...
	"github.com/warjiang/new-api/relaykit/relayconvert"
