...
| `repos/tanstack-router` | `@tanstack/react-router 1.170.18` | `https://github.com/TanStack/router.git` | `@tanstack/react-router@1.170.18` |
| `repos/tanstack-table` | `@tanstack/react-table 8.21.3` | `https://github.com/TanStack/table.git` | `v8.21.3` |
| `repos/tanstack-virtual` | `@tanstack/react-virtual 3.14.6` | `https://github.com/TanStack/virtual.git` | `@tanstack/react-virtual@3.14.6` |
| `repos/react-hook-form` | `react-hook-form 7.82.0` | `https://github.com/react-hook-form/react-hook-form.git` | `v7.82.0` |
| `repos/zod` | `zod 4.4.3` | `https://github.com/colinhacks/zod.git` | `v4.4.3` |
| `repos/i18next` | `i18next 26.3.6` | `https://github.com/i18next/i18next.git` | `v26.3.6` |
| `repos/react-i18next` | `react-i18next 17.0.10` | `https://github.com/i18next/react-i18next.git` | `v17.0.10` |
| `repos/zustand` | `zustand 5.0.14` | `https://github.com/pmndrs/zustand.git` | `v5.0.14` |
| `repos/tailwindcss` | `tailwindcss 4.3.3` | `https://github.com/tailwindlabs/tailwindcss.git` | `v4.3.3` |
| `repos/rsbuild` | `@rsbuild/core 2.1.6` | `https://github.com/web-infra-dev/rsbuild.git` | `v2.1.6` |
| `repos/ai` | `ai 7.0.31` | `https://github.com/vercel/ai.git` | `ai@7.0.31` |
| `repos/vchart` | `@visactor/vchart 2.1.4` | `https://github.com/VisActor/VChart.git` | `0cca7f124f0e626868da4f294d030b0d1edf4e16` (`npm` package `gitHead`) |
...
Keep the worktree clean. First update the normal dependency manifest and lockfile, identify the exact lockfile resolution and its matching upstream tag or package `gitHead`, then run:
