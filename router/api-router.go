...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/register", middleware.CriticalRateLimit(), middleware.RegistrationRateLimit(), anonymousRequestBodyLimit, middleware.TurnstileCheck(), controller.Register)
