...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.POST("/dodo/webhook", anonymousRequestBodyLimit, controller.DodoWebhook)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/dodo/pay", middleware.CriticalRateLimit(), controller.RequestDodoPay)
				selfRoute.POST("/dodo/amount", controller.RequestDodoAmount)
