...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.POST("/reset_api_key", middleware.DisableCache(), middleware.CriticalRateLimit(), middleware.EmailVerificationRateLimit(), middleware.APIKeyRecoveryRateLimit(), anonymousRequestBodyLimit, middleware.TurnstileCheck(), controller.SendAPIKeyResetEmail)
		apiRouter.POST("/user/reset-api-key", middleware.DisableCache(), middleware.CriticalRateLimit(), anonymousRequestBodyLimit, middleware.TurnstileCheck(), controller.ResetAPIKey)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/invite", middleware.AdminAuth(), middleware.CriticalRateLimit(), anonymousRequestBodyLimit, controller.SendUserInvite)
			...
			userRoute.POST("/login/api-key", middleware.CriticalRateLimit(), middleware.DisableCache(), anonymousRequestBodyLimit, middleware.TurnstileCheck(), controller.APIKeyLogin)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/rotate-api-key", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.RotatePrimaryAPIKey)
