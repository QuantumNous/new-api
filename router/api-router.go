...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		logRoute.GET("/analysis", middleware.CORS(), middleware.AnalysisRateLimit(), middleware.AdminAuth(), controller.GetLogUsageAnalysis)
		logRoute.GET("/self/stat", middleware.UserAuth(), controller.GetLogsSelfStat)
		logRoute.GET("/self/export/summary", middleware.UserAuth(), controller.GetLogSelfUsageSummary)
		logRoute.GET("/self/analysis", middleware.CORS(), middleware.AnalysisRateLimit(), middleware.UserAuth(), controller.GetLogSelfUsageAnalysis)
