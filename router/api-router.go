...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/query-key/report", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.QueryChannelKeyReport)
			channelRoute.POST("/query-key/test", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.QueryChannelKeyTest)
