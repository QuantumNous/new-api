...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GeoIPHeader())
	{
		...
		apiRouter.GET("/verification", middleware.EmailVerificationRateLimit(), middleware.TurnstileCheck(), middleware.CaptchaCheck(), controller.SendEmailVerification)
		apiRouter.GET("/reset_password", middleware.CriticalRateLimit(), middleware.TurnstileCheck(), middleware.CaptchaCheck(), controller.SendPasswordResetEmail)
		...
		{
			userRoute.POST("/register", middleware.CriticalRateLimit(), middleware.TurnstileCheck(), middleware.CaptchaCheck(), controller.Register)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/self/toggle/:id", controller.ToggleSubscriptionDisabled)
			subscriptionRoute.POST("/self/cancel/:id", controller.UserCancelSubscription)
			// subscriptionRoute.DELETE("/self/:id", controller.UserDeleteSubscription)
