	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/invitation_rebate/self/summary", controller.GetSelfInvitationRebateSummary)
				selfRoute.GET("/invitation_rebate/self/invitees", controller.GetSelfInvitationRebateInvitees)
				selfRoute.GET("/invitation_rebate/self/records", controller.GetSelfInvitationRebateRecords)
				selfRoute.GET("/invitation_rebate/self/records/:id", controller.GetSelfInvitationRebateRecordDetail)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/invitation_rebate", controller.GetAllInvitationRebateRecords)
				adminRoute.GET("/invitation_rebate/:id", controller.GetInvitationRebateRecordDetail)
