...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.POST("/airwallex/webhook/:biz", controller.AirwallexWebhook)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/topup/airwallex/methods", controller.GetAirwallexPaymentMethodTypes)
				selfRoute.POST("/topup/airwallex/pay", middleware.CriticalRateLimit(), controller.RequestAirwallexPay)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.GET("/dynamic/settings", controller.GetChannelDynamicSettings)
			channelRoute.PUT("/dynamic/settings", controller.UpdateChannelDynamicSettings)
			channelRoute.GET("/dynamic/overrides", controller.GetChannelDynamicOverrides)
			channelRoute.GET("/dynamic/logs", controller.GetChannelDynamicLogs)
			channelRoute.GET("/dynamic/probes", controller.GetChannelDynamicProbes)
