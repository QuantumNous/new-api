...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.POST("/allscale/webhook", middleware.CriticalRateLimit(), controller.AllScaleWebhook)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/allscale/amount", controller.RequestAllScaleAmount)
			    selfRoute.POST("/allscale/pay", middleware.CriticalRateLimit(), controller.RequestAllScalePay)
			    selfRoute.GET("/allscale/status", controller.GetAllScaleStatus)
