...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/reset_api_key", middleware.DisableCache(), middleware.CriticalRateLimit(), middleware.EmailVerificationRateLimit(), middleware.APIKeyRecoveryRateLimit(), middleware.TurnstileCheck(), controller.SendAPIKeyResetEmail)
