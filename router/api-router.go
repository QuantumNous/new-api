...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		logRoute.GET("/statistics", middleware.UserAuth(), controller.GetLogStatistics)
		logRoute.GET("/statistics/export", middleware.UserAuth(), controller.ExportLogStatistics)
		logRoute.GET("/statistics/options/users", middleware.AdminAuth(), controller.GetStatisticsUserOptions)
		logRoute.GET("/statistics/options/tokens", middleware.UserAuth(), controller.GetStatisticsTokenOptions)
		logRoute.GET("/statistics/options/models", middleware.UserAuth(), controller.GetStatisticsModelOptions)
