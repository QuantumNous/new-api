...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/verification", middleware.EmailVerificationRateLimit(), middleware.ESACaptchaCheck("verification"), controller.SendEmailVerification)
		apiRouter.GET("/reset_password", middleware.CriticalRateLimit(), middleware.ESACaptchaCheck("reset_password"), controller.SendPasswordResetEmail)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/login", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, middleware.ESACaptchaCheck("login"), controller.Login)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.DELETE("/self", middleware.ESACaptchaCheck("delete_account"), controller.DeleteSelf)
				...
				selfRoute.POST("/checkin", middleware.ESACaptchaCheck("checkin"), controller.DoCheckin)
