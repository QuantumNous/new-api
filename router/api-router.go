	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.DisableCache(), middleware.UserAuth())
			{
				...
				selfRoute.GET("/sessions/del/:sid", middleware.DisableCache(), controller.DeleteLoginSession)
				...
				selfRoute.POST("/self/put", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.UpdateSelf)
				selfRoute.GET("/self/del", middleware.DisableCache(), controller.DeleteSelf)
				...
				selfRoute.GET("/token/del", middleware.CriticalRateLimit(), middleware.UserCriticalRateLimit("access-token"), middleware.DisableCache(), controller.RevokeAccessToken)
				...
				selfRoute.GET("/passkey/del", middleware.DisableCache(), controller.PasskeyDelete)
				...
				selfRoute.POST("/setting/put", controller.UpdateUserSetting)
				...
				selfRoute.GET("/oauth/bindings/del/:provider_id", controller.UnbindCustomOAuth)
			}
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/del/:id/oauth/bindings/del/:provider_id", controller.UnbindCustomOAuthByAdmin)
				adminRoute.GET("/del/:id/bindings/del/:binding_type", controller.AdminClearUserBinding)
				adminRoute.GET("/:id", controller.GetUser)
				adminRoute.POST("/", controller.CreateUser)
				adminRoute.POST("/manage", controller.ManageUser)
				adminRoute.POST("/put", controller.UpdateUser)
				adminRoute.GET("/del/:id", controller.DeleteUser)
				adminRoute.GET("/del/:id/reset_passkey", controller.AdminResetPasskey)

				// Admin 2FA routes
				adminRoute.GET("/2fa/stats", controller.Admin2FAStats)
				adminRoute.GET("/del/:id/2fa", controller.AdminDisable2FA)
			}
		}
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/self/preference/put", controller.UpdateSubscriptionPreference)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.POST("/plans/put/:id", controller.AdminUpdateSubscriptionPlan)
			...
			subscriptionAdminRoute.GET("/user_subscriptions/del/:id", controller.AdminDeleteUserSubscription)
		}
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/put", controller.UpdateOption)
			optionRoute.POST("/passkey/domains/put", controller.UpdatePasskeyDomains)
			...
			optionRoute.GET("/channel_affinity_cache/del", controller.ClearChannelAffinityCache)
		...
		customOAuthRoute.Use(middleware.RootAuth())
		{
			...
			customOAuthRoute.POST("/put/:id", controller.UpdateCustomOAuthProvider)
			customOAuthRoute.GET("/del/:id", controller.DeleteCustomOAuthProvider)
		}
		performanceRoute := apiRouter.Group("/performance")
		performanceRoute.Use(middleware.RootAuth())
		{
			performanceRoute.GET("/stats", controller.GetPerformanceStats)
			performanceRoute.GET("/disk_cache/del", controller.ClearDiskCache)
			performanceRoute.POST("/reset_stats", controller.ResetPerformanceStats)
			performanceRoute.POST("/gc", controller.ForceGC)
			performanceRoute.GET("/logs", controller.GetLogFiles)
			performanceRoute.GET("/logs/del", controller.CleanupLogFiles)
		}
		...
		taskPluginRoute.Use(middleware.RootAuth())
		{
			...
			taskPluginRoute.POST("/put", controller.UploadTaskPlugin)
			...
			taskPluginRoute.POST("/marketplace/sources/put", controller.UpdateTaskPluginMarketplaceSources)
			...
			taskPluginRoute.GET("/del/:key/versions/del/:version", controller.DeleteTaskPluginVersion)
		}
		...
		tokenRoute.Use(middleware.TokenOperationAudit())
		{
			...
			tokenRoute.POST("/put", controller.UpdateToken)
			tokenRoute.GET("/del/:id", controller.DeleteToken)
		...
		redemptionRoute.Use(middleware.AdminAuth())
		{
			...
			redemptionRoute.POST("/put", controller.UpdateRedemption)
			redemptionRoute.GET("/invalid/del", controller.DeleteInvalidRedemption)
			redemptionRoute.GET("/del/:id", controller.DeleteRedemption)
		}
		...
		systemInfoRoute.Use(middleware.RootAuth())
		{
			...
			systemInfoRoute.GET("/stale-instances/del", controller.DeleteStaleSystemInstances)
			systemInfoRoute.GET("/instances/del/:node_name", controller.DeleteStaleSystemInstance)
		}
		...
		prefillGroupRoute.Use(middleware.AdminAuth())
		{
			...
			prefillGroupRoute.POST("/put", controller.UpdatePrefillGroup)
			prefillGroupRoute.GET("/del/:id", controller.DeletePrefillGroup)
		}
		...
		vendorRoute.Use(middleware.AdminAuth())
		{
			...
			vendorRoute.POST("/put", controller.UpdateVendorMeta)
			vendorRoute.GET("/del/:id", controller.DeleteVendorMeta)
		}
		...
		modelsRoute.Use(middleware.AdminAuth())
		{
			...
			modelsRoute.POST("/put", controller.UpdateModelMeta)
			modelsRoute.GET("/del/:id", controller.DeleteModelMeta)
		}
		...
		deploymentsRoute.Use(middleware.AdminAuth())
		{
			...
			deploymentsRoute.POST("/put/:id", controller.UpdateDeployment)
			deploymentsRoute.POST("/put/:id/name", controller.UpdateDeploymentName)
			deploymentsRoute.POST("/:id/extend", controller.ExtendDeployment)
			deploymentsRoute.GET("/del/:id", controller.DeleteDeployment)
		}
	}
}
