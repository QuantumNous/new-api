...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/balance_config/:id", permission: authz.ChannelSensitiveWrite, handler: controller.GetChannelBalanceConfig},
	{method: http.MethodPut, path: "/balance_config/:id", permission: authz.ChannelSensitiveWrite, handler: controller.SetChannelBalanceConfig},
