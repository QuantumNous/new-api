...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodPost, path: "/put", permission: authz.ChannelWrite, handler: controller.UpdateChannel},
	...
	{method: http.MethodGet, path: "/disabled/del", permission: authz.ChannelSensitiveWrite, handler: controller.DeleteDisabledChannel},
	...
	{method: http.MethodPost, path: "/tag/put", permission: authz.ChannelWrite, handler: controller.EditTagChannels},
	{method: http.MethodGet, path: "/del/:id", permission: authz.ChannelSensitiveWrite, handler: controller.DeleteChannel},
	...
	{method: http.MethodGet, path: "/ollama/delete/del", permission: authz.ChannelSensitiveWrite, handler: controller.OllamaDeleteModel},
