...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodDelete, path: "/disabled", permission: authz.ChannelWrite, handler: controller.DeleteDisabledChannel},
	...
	{method: http.MethodDelete, path: "/:id", permission: authz.ChannelWrite, handler: controller.DeleteChannel},
	{method: http.MethodPost, path: "/batch", permission: authz.ChannelWrite, handler: controller.DeleteChannelBatch},
	...
	{method: http.MethodGet, path: "/ollama/version/:id", permission: authz.ChannelRead, handler: controller.OllamaVersion},
