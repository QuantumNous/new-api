...
func SetRelayRouter(router *gin.Engine) {
	...
	relayV1Router.Use(middleware.ModelRequestRateLimit())
	{
		...
		wsRouter.Use(middleware.Distribute(), middleware.HeaderCapture())
	...
	}
	{
		...
		httpRouter.Use(middleware.Distribute(), middleware.HeaderCapture())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.Distribute(), middleware.HeaderCapture())
	{
	...
	relayGeminiRouter.Use(middleware.Distribute(), middleware.HeaderCapture())
	{
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.Distribute(), middleware.HeaderCapture())
	{
