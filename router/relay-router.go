...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth())
	{
		...
		playgroundSubmitRouter.POST("/images/generations", controller.PlaygroundImageGenerations)
		playgroundSubmitRouter.POST("/images/edits", controller.PlaygroundImageEdits)
		playgroundSubmitRouter.POST("/images/async-generations", controller.PlaygroundAsyncImageGenerations)
		playgroundSubmitRouter.POST("/images/async-edits", controller.PlaygroundAsyncImageEdits)
		playgroundSubmitRouter.POST("/video/generations", controller.PlaygroundVideoSubmit)
		playgroundSubmitRouter.POST("/video/async-generations", controller.PlaygroundAsyncVideoSubmit)

		playgroundRouter.GET("/images/async-generations/:task_id", controller.PlaygroundAsyncImageFetch)
		playgroundRouter.GET("/images/async-edits/:task_id", controller.PlaygroundAsyncImageFetch)
		playgroundRouter.GET("/video/generations/:task_id", controller.PlaygroundVideoFetch)
		playgroundRouter.GET("/video/async-generations/:task_id", controller.PlaygroundAsyncVideoFetch)
	}
