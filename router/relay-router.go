...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.PrivacyFilter(), middleware.Distribute())
	{
	...
	}
	{
		...
		httpRouter.Use(middleware.PrivacyFilter(), middleware.Distribute())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.PrivacyFilter(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.PrivacyFilter(), middleware.Distribute())
	{
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.PrivacyFilter(), middleware.Distribute())
	{
