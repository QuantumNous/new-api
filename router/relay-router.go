...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.Distribute())
	{
		...
		playgroundRouter.POST("/images/async-generations", controller.PlaygroundAsyncImageGenerations)
		playgroundRouter.POST("/images/async-edits", controller.PlaygroundAsyncImageEdits)
		...
		playgroundRouter.POST("/video/async-generations", controller.PlaygroundAsyncVideoSubmit)
