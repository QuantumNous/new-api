...
BACKEND_URL="${VITE_REACT_APP_SERVER_URL:-http://localhost:3000}"
...
default_cmd="VITE_REACT_APP_SERVER_URL='$BACKEND_URL' bun run dev -- --host 0.0.0.0 --port '$DEFAULT_PORT'"
classic_cmd="VITE_REACT_APP_SERVER_URL='$BACKEND_URL' bun run dev -- --host 0.0.0.0 --port '$CLASSIC_PORT'"
