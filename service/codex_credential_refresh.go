...
func parseCodexOAuthKey(raw string) (*CodexOAuthKey, error) {
	if strings.TrimSpace(raw) == "" {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "svc.codex_channel_empty_oauth_key"))
	}
	var key CodexOAuthKey
	if err := common.Unmarshal([]byte(raw), &key); err != nil {
		return nil, errors.New(i18n.Translate(i18n.DefaultLang, "svc.codex_channel_invalid_oauth_key_json"))
	}
	return &key, nil
}
...
func RefreshCodexChannelCredential(ctx context.Context, channelID int, opts CodexCredentialRefreshOptions) (*CodexOAuthKey, *model.Channel, error) {
	...
	if ch == nil {
		return nil, nil, errors.New(i18n.Translate(i18n.DefaultLang, "model.channel_not_found"))
	}
	if ch.Type != constant.ChannelTypeCodex {
		return nil, nil, errors.New(i18n.Translate(i18n.DefaultLang, "svc.channel_type_is_not_codex"))
	}
	...
	if strings.TrimSpace(oauthKey.RefreshToken) == "" {
		return nil, nil, errors.New(i18n.Translate(i18n.DefaultLang, "svc.codex_channel_refresh_token_is_required_to_refresh"))
	}
