...
func InitTokenEncoders() {
	common.SysLog(i18n.Translate(i18n.DefaultLang, "svc.initializing_token_encoders"))
	defaultTokenEncoder = codec.NewCl100kBase()
	common.SysLog(i18n.Translate(i18n.DefaultLang, "svc.token_encoders_initialized"))
}
