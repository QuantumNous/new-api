...
func TestClaudeSettingsWriteHeadersMergesConfiguredValuesIntoSingleHeader(t *testing.T) {
	...
	assert.Equal(t, []string{"output-128k-2025-02-19,token-efficient-tools-2025-02-19"}, headers.Values("anthropic-beta"))
}
...
func TestClaudeSettingsWriteHeadersDeduplicatesAcrossCommaSeparatedAndRepeatedValues(t *testing.T) {
	...
	assert.Equal(t, []string{"output-128k-2025-02-19,token-efficient-tools-2025-02-19,computer-use-2025-01-24"}, headers.Values("anthropic-beta"))
}
