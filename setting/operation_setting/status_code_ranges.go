...
// Default behavior: retry for 1xx, 3xx, 4xx(except 400/408), 5xx(except 504), and no retry for 2xx.
// 504/524/bad_response_body are retried so multi-channel fallback can kick in.
