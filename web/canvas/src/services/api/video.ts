...
import { buildApiUrl, isBuiltinRequestConfig, modelOptionName, resolveModelRequestConfig, type AiConfig } from "@/stores/use-config-store";
...
function assertVideoConfig(config: AiConfig, model: string) {
    ...
    if (!config.apiKey.trim() && !isBuiltinRequestConfig(config)) throw new Error("请先配置 API Key");
