...
import VideoInputRatioSettings from '../../pages/Setting/Ratio/VideoInputRatioSettings';
    ...
    <Spin spinning={loading} size='large'>
      <Card style={{ marginTop: '10px' }}>
        <Tabs type='card' defaultActiveKey='pricing'>
          ...
          <Tabs.TabPane tab={t('视频参考计费')} itemKey='video_input_ratio'>
            <VideoInputRatioSettings options={inputs} />
          </Tabs.TabPane>
        </Tabs>
      </Card>
    </Spin>
