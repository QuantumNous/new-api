    ...
    if (name === 'type') {
      ...
      switch (value) {
        ...
        case 64: // th12345ai (TH API)
          ...
          break;
        case 65: // megabyai
          localModels = ['videos-standard', 'videos-fast', 'videos-mini'];
          setInputs((prevInputs) => ({
            ...prevInputs,
              ...
              <div className='p-2 space-y-3' ref={formContainerRef}>
                ...
                <Card className='!rounded-2xl shadow-sm border-0'>
                  ...
                  <div className='flex items-center mb-4'>
                    ...
                    {(inputs.type === 58 || inputs.type === 59 || inputs.type === 60 || inputs.type === 61 || inputs.type === 62 || inputs.type === 63 || inputs.type === 64 || inputs.type === 65 || inputs.type === 66 || inputs.type === 67 || inputs.type === 68 || inputs.type === 69) && (
                      <Banner
                        type='info'
                        closeIcon={null}
                        className='mb-4 rounded-xl'
