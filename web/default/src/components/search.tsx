...
export function Search({ className = '', placeholder }: SearchProps) {
  ...
  return (
    <Button
      variant='outline'
      className={cn(
        'bg-muted/25 group text-muted-foreground hover:bg-accent relative h-8 w-full max-w-full min-w-0 justify-start overflow-hidden rounded-md text-sm font-normal shadow-none pe-2 sm:pe-12',
        className
      )}
    ...
    >
      <SearchIcon
        ...
        size={16}
      />
      <span className='ms-4 truncate'>{resolvedPlaceholder}</span>
