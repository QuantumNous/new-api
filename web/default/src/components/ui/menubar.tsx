...
function MenubarContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(
        'dark bg-popover text-popover-foreground ring-foreground/10 min-w-36 rounded-lg p-1 shadow-md ring-1',
        className
      )}
      {...props}
    />
...
function MenubarSubContent({
  ...
  return (
    <DropdownMenuSubContent
      ...
      className={cn(
        'dark bg-popover text-popover-foreground ring-foreground/10 min-w-32 rounded-lg p-1 shadow-lg ring-1',
        className
      )}
      {...props}
    />
