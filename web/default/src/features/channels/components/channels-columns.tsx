  ...
  if ((maxConcurrency ?? 0) > 0 && status) {
    ...
    badge = (
      <div className='mb-1 flex items-center gap-1'>
        ...
        {status.cooling_down && (
          <span className='inline-flex items-center rounded-full bg-blue-100 px-1.5 py-0.5 text-xs font-medium text-blue-700 dark:bg-blue-900/30 dark:text-blue-400'>
            {t('Cooling')}
          </span>
        )}
      </div>
