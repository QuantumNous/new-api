    ...
    () => [
      ...
      // Status column
      {
        ...
        cell: ({ row }) => {
          ...
          // Cooling down is orthogonal to enable/disable status: surface a
          // warning badge with the reason and remaining time so admins can see
          // why a channel is temporarily skipped during selection.
