...
const CHANNEL_TYPE_DISPLAY_ORDER: number[] = [
  ...
  51, 52, 53, 54, 55, 56, 58, 59, 60, 61, 62, 63, 64, 65, 66, 67, 68, 69,
]
...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  58: 'Format: sk-... (Bearer token for ApiWenhao)',
  ...
  63: 'Format: Bearer token (7tai / 炳火 API Key)',
  ...
  68: 'Format: Bearer token (catertx / mao API Key)',
  69: 'Format: Bearer token (KYY / yk-video API Key)',
}
