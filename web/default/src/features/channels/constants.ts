...
export const CHANNEL_TYPES = {
  ...
  56: 'Replicate',
  57: 'Codex',
  58: 'Claude Platform on AWS',
} as const

const CHANNEL_TYPE_DISPLAY_ORDER: number[] = [
  1, 14, 58, 33, 24, 43, 3, 41, 48, 42, 34, 20, 4, 40, 27, 25, 17, 26, 15, 46,
...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  58: 'API Key mode: paste the key from AWS Console. SigV4 mode: format AK|SK or AK|SK|SessionToken',
}
