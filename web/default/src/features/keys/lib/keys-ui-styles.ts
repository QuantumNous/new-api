...
*/
/**
 * Light ops-console UI tokens for application access keys (/keys).
 */
...
export const keysHeaderSortButtonClassName = cn(
  'relative h-8 shrink-0 px-1.5 font-medium text-slate-700',
  'hover:bg-blue-50 hover:text-blue-700',
  'data-popup-open:bg-blue-50'
)

export const keysHeaderSortIconClassName =
  'pointer-events-none absolute start-full top-1/2 ms-0.5 size-4 -translate-y-1/2 text-slate-500'
...
export const keysActionsStickyCellClassName = cn(
  ...
  'border-l border-[#DBEAFE] bg-white',
  'shadow-[-8px_0_12px_-8px_rgba(15,23,42,0.06)]'
)
...
export const keysTableRowBaseClassName = cn(
  ...
  'hover:!bg-[#EFF6FF]',
  'has-aria-expanded:!bg-blue-50/80',
  'data-[state=selected]:!bg-blue-50',
  'data-[state=selected]:hover:!bg-blue-100/60',
  'data-[state=selected]:!text-slate-900',
  '[&>td]:align-middle',
  '[&>td]:!text-slate-800',
  '[&>td_span]:!text-slate-800',
  '[&>td_p]:!text-slate-800',
  '[&>td_.text-muted-foreground]:!text-slate-500',
  '[&>td_.text-slate-700]:!text-slate-800',
  '[&[data-state=selected]>td:last-child]:!bg-blue-50'
)

/** Disabled key rows */
export const keysDisabledRowDesktopClassName = cn(
  '[&>td:first-child]:border-l-4 [&>td:first-child]:border-l-slate-300 [&>td:first-child]:pl-1',
  '!bg-slate-50/90 hover:!bg-slate-100/80',
  'data-[state=selected]:!bg-blue-50',
  'data-[state=selected]:hover:!bg-blue-100/60',
  '[&>td]:opacity-100',
  '[&>td:last-child]:!bg-slate-50/90'
)

export const keysDisabledRowMobileClassName = cn(
  'border-l-4 border-l-slate-300 !bg-slate-50/90'
)
...
export const keysDropdownMenuContentClassName = cn(
  'min-w-[220px] border border-[#DBEAFE] bg-white p-1 text-slate-800 shadow-lg ring-1 ring-blue-100/50'
)
...
export const keysDropdownMenuSeparatorClassName = 'bg-[#DBEAFE]'

export const keysDropdownMenuShortcutClassName = 'text-slate-400'

/** Subdued group ratio badge (keys table only) */
export const keysGroupRatioBadgeClassName = cn(
  'inline-flex shrink-0 cursor-default items-center rounded border border-[#DBEAFE]',
  'bg-[#F8FBFF] px-0.5 py-px font-mono text-[9px] leading-none tabular-nums text-slate-500'
)

export const keysMobileShellClassName =
  'overflow-hidden rounded-lg border border-[#DBEAFE] bg-white'

export const keysTablePrimaryClass = 'text-slate-800'

export const keysTableMetaClass = 'text-xs font-medium text-slate-500'

export const keysTableEmptyClass = 'text-xs text-slate-500'

export const keysCheckboxClassName =
  'translate-y-[2px] border-slate-300 data-[state=checked]:border-blue-500 data-[state=checked]:bg-blue-600'
...
export const keysBulkPanelClassName = cn(
  'border-[#DBEAFE] bg-white text-slate-800 shadow-lg',
  '[&_button]:text-slate-700'
)

export const keysBulkCountTextClassName = 'text-slate-600'
...
export const keysTooltipContentClassName = cn(
  'border border-[#DBEAFE] bg-white text-slate-800 shadow-md'
)
