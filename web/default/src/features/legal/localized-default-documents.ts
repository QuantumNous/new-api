...
このユーザー契約 (「契約」) は、VOC AI INC (「VOC AI」、「当社」、「当社」) が flatkey.ai、ダッシュボード、API、チェックアウト ページ、ドキュメント、サポート チャネルを通じて提供する Flatkey AI サービス (「サービス」) に適用されます。アカウントの登録、組織の作成、プリペイド アカウント残高の追加、API キーの生成または使用、モデル API の呼び出し、ダッシュボードへのアクセス、またはその他のサービスの使用により、お客様は、本契約、当社のプライバシー ポリシー、返金ポリシー、ドキュメント、価格設定ページ、および該当する補足規則に同意したものとみなされます。

運営主体: VOC AI INC、160 E Tasman Drive、Suite 202、San Jose、CA 95134、United States。連絡先: support@flatkey.ai。
...
本契約、注文、請求、返金、コンプライアンス、通知、またはサービスの問題に関するご質問については、support@flatkey.ai にお問い合わせいただくか、VOC AI INC, 160 E Tasman Drive, Suite 202, San Jose, CA 95134, United States まで書面でご連絡ください。
...
このプライバシー ポリシーでは、お客様が flatkey.ai、Flatkey AI サービス、関連 Web サイト、ダッシュボード、API、チェックアウト ページ、ドキュメント、サポート チャネルにアクセスまたは使用する際に、VOC AI INC (「VOC AI」、「当社」、「当社」) がどのように情報を収集、使用、共有、保持、保護するかについて説明します。
...
VOC AI は米国にあります。当社、当社のサービスプロバイダー、決済サービスプロバイダー、およびサードパーティのサービスプロバイダーは、米国、ヨーロッパ、アジア、またはその他の国や地域で情報を処理する場合があります。それらの地域のデータ保護法は、お客様の所在地の法律と異なる場合があります。当社は、適用法で義務付けられている場合には、適切な国境を越えた転送の保護措置を講じます。
...
プライバシーに関するご質問、データリクエスト、セキュリティレポート、またはデータ保護に関するお問い合わせについては、support@flatkey.ai にご連絡いただくか、VOC AI INC, 160 E Tasman Drive, Suite 202, San Jose, CA 95134, United States まで書面でご連絡ください。
...
この返金ポリシーは、VOC AI INC (「VOC AI」、「当社」、「当社」) が flatkey.ai、チェックアウト ページ、ダッシュボード、サポート チャネルを通じて提供する Flatkey AI サービス (アカウントのチャージ、プリペイド アカウント残高、サービス クレジット、API の使用状況、デジタル サービスの提供、および関連するサポート事項を含む) に適用されます。
...
購入、配送、アカウント残高、サービス クレジット、重複請求、誤った控除、税金、請求書、領収書、返金資格、Paddle の領収書、Stripe の領収書、または支払いに関する紛争に関するご質問については、support@flatkey.ai までご連絡いただくか、VOC AI INC, 160 E Tasman Drive, Suite 202, San Jose, CA 95134, United States まで書面でご連絡ください。
...
Все вышеперечисленное содержимое подлежит английской версии.`,
  ...
  vi: {
    terms: `# Thỏa thuận người dùng AI Flatkey
...
Tài khoản AI Flatkey, khóa API, số dư tài khoản, tín dụng dịch vụ, khả năng truy cập mô hình và khả năng bảng điều khiển sẽ được bạn và nhóm được ủy quyền của bạn sử dụng trong doanh nghiệp hoặc ứng dụng của riêng bạn.Trừ khi chúng tôi ký kết một thỏa thuận bằng văn bản riêng, bạn không được cung cấp Flatkey AI cho bên thứ ba dưới dạng API độc lập, số dư, tín dụng, tài khoản phụ, dịch vụ nạp tiền, dịch vụ chuyển tiếp, dịch vụ đổi thương hiệu, dịch vụ tổng hợp hoặc dịch vụ tương tự, cho dù bằng cách bán, chuyển nhượng, phân phối, cho thuê, chia sẻ hoặc sắp xếp gián tiếp khác.
...
Chính sách quyền riêng tư này giải thích cách VOC AI INC ("VOC AI", "chúng tôi" hoặc "của chúng tôi") thu thập, sử dụng, chia sẻ, lưu giữ và bảo vệ thông tin khi bạn truy cập hoặc sử dụng các dịch vụ flatkey.ai, Flatkey AI, các trang web, trang tổng quan, API, trang thanh toán, tài liệu và kênh hỗ trợ có liên quan.
