...
export function transformFormDataToModelPayload(
  ...
  return {
    ...
    input_modalities: formData.input_modalities as Model['input_modalities'],
    output_modalities: formData.output_modalities as Model['output_modalities'],
    capabilities: formData.capabilities as Model['capabilities'],
