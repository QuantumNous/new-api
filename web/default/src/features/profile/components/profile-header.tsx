...
import { formatCompactNumber, formatQuota, quotaToNumber } from '@/lib/format'
  ...
  const stats = [
    {
      ...
      value: formatQuota(quotaToNumber(profile.quota)),
      description: t('Remaining quota'),
      icon: WalletCards,
    },
    {
      label: t('Total Usage'),
      value: formatQuota(quotaToNumber(profile.used_quota)),
