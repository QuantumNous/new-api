    ...
    build: (settings: AuthSettings) => (
      <OAuthSection
        defaultValues={{
          ...
          'ldap.user_dn': settings['ldap.user_dn'],
          'ldap.bind_dn': settings['ldap.bind_dn'],
          'ldap.bind_pass': settings['ldap.bind_pass'],
          'ldap.user_filter': settings['ldap.user_filter'],
          'ldap.username_attr': settings['ldap.username_attr'],
          'ldap.display_name_attr': settings['ldap.display_name_attr'],
          'ldap.email_attr': settings['ldap.email_attr'],
          'ldap.group_filter': settings['ldap.group_filter'],
          'ldap.group_name_attr': settings['ldap.group_name_attr'],
          'ldap.member_attr': settings['ldap.member_attr'],
          'ldap.use_tls': settings['ldap.use_tls'],
          'ldap.insecure': settings['ldap.insecure'],
          'ldap.group_whitelist': settings['ldap.group_whitelist'],
          'ldap.user_whitelist': settings['ldap.user_whitelist'],
