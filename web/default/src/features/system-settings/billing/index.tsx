...
const defaultBillingSettings: BillingSettings = {
  ...
  InviteTopupRebateValidDays: 30,
  TopUpLink: '',
  'general_setting.docs_link': '',
  'quota_setting.enable_free_model_pre_consume': true,
  'quota_setting.zero_output_quota_exemption_enabled': false,
  'quota_setting.zero_output_quota_exemption_global': false,
  'quota_setting.zero_output_quota_exemption_user_list': '',
  QuotaPerUnit: 500000,
  USDExchangeRate: 7,
