    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          AmountBonusGroups: settings['payment_setting.amount_bonus_groups'],
          ...
          StripePriceIdJPY20: settings.StripePriceIdJPY20 ?? '',
          StripePriceIdJPY200: settings.StripePriceIdJPY200 ?? '',
          StripePriceIdBRL: settings.StripePriceIdBRL,
          StripePriceIdBRL20: settings.StripePriceIdBRL20 ?? '',
          StripePriceIdBRL200: settings.StripePriceIdBRL200 ?? '',
