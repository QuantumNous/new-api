...
const defaultOperationsSettings: OperationsSettings = {
  ...
  'monitor_setting.channel_monitor_enabled': true,
  'monitor_setting.channel_monitor_default_interval_seconds': 60,
  SMTPServer: '',
  SMTPPort: '',
  SMTPAccount: '',
  SMTPFrom: '',
  ...
  'cdk_tool_setting.enabled': false,
  'cdk_tool_setting.service_user_id': 0,
  'cdk_tool_setting.token_group': '',
  'cdk_tool_setting.token_name_prefix': 'cdk-tool',
