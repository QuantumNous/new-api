...
export type RedemptionRedeemResult =
  | number
  | {
...
export type RedemptionResponse = ApiResponse<RedemptionRedeemResult>
...
export interface InviteCodeCreateRequest {
  /** Display name for generated codes */
  name?: string
  /** Number of invite codes to create */
  count: number
