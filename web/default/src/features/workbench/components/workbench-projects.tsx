...
import { DEFAULT_VIEWPORT } from '../store/canvas-store'
import type { CanvasProjectMeta } from '../types'

const PROJECTS_QUERY_KEY = ['workbench', 'canvas-projects']
        ...
        <div className='grid gap-3 sm:grid-cols-2 lg:grid-cols-3'>
          {filteredProjects.map((project) => (
            ...
            >
              <button
                type='button'
                className='bg-muted block w-full'
                onClick={() =>
                  navigate({
                    to: '/workbench/$projectId',
                    params: { projectId: String(project.id) },
              ...
              >
                {project.cover ? (
                  ...
                  <div className='bg-muted h-32 w-full' aria-hidden='true' />
                )}
              </button>
