...
export const STATIC_I18N_KEYS = [
  ...
  'Your subscription is active. Redirecting to wallet...',
  'The payment was not completed. Please start a new order.',
  'This payment order has expired. Please start a new order.',
  'If you have paid, keep this page open or refresh your subscription status later.',
  'Open the subscription page and start payment again.',
  ...
  'No order number',
  'Last checked',
  'Unable to query payment status yet',
