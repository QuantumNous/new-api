...
export const STATIC_I18N_KEYS = [
  ...
  // Admin pricing ratio calculator
  'Pricing Ratio Calculator',
  'Admin only',
  'Calculation inputs',
  'Use costs and usage from the same account reset period.',
  'Account cost presets',
  'Cost per account',
  'CNY',
  'Account quota period',
  'Observed standard usage (A)',
  'Quota consumed',
  'Accounting period',
  'Manual group ratio',
  'Target gross margin',
  'U equals A multiplied by the group ratio.',
  'Pricing result',
  'All results are estimates for internal pricing decisions.',
  'Suggested ratio at target margin',
  'Cost covered',
  'Below break-even',
  'Full account-period A',
  'Observed A divided by consumed percentage',
  'Accounting-period A',
  '{{count}} account equivalents',
  'Revenue at manual ratio',
  'A multiplied by the manual ratio',
  'Gross profit at manual ratio',
  'Gross margin: {{margin}}',
  'Ratio scenarios',
  'Same usage pool, different ratios',
  'Ratio',
  'Revenue',
  'Gross profit',
  'Gross margin',
  'Full account-period A = observed A / consumed percentage',
  'Break-even ratio = account cost / full account-period A',
  'U = A × group ratio',
  'Estimation notice',
