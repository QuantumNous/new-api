...
export const STATIC_I18N_KEYS = [
  ...
  'Failed to create CC Switch import link',
  'Opening CC Switch...',
  'Opening...',
  'Failed to load import options',
  'Enter model name, e.g. codex / sonnet / qwen',
  'Search results',
  ...
  'Enter model name',
  'Use this token in the Codex desktop app',
  'Use this token in the Claude Code plugin',
  'Import to Codex',
  'Import to Claude Code',
  'Enable these options in CC Switch manually',
