...
const AuthenticatedHelpPricingRoute =
  AuthenticatedHelpPricingRouteImport.update({
    id: '/help/pricing',
    path: '/help/pricing',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/onboarding/$slug': {
      ...
      preLoaderRoute: typeof OnboardingSlugRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/oauth/$provider': {
      id: '/oauth/$provider'
    ...
    '/_authenticated/help/pricing': {
      id: '/_authenticated/help/pricing'
      path: '/help/pricing'
      fullPath: '/help/pricing'
