...
const LoginForm = () => {
  ...
  const brandName = systemName === 'New API' ? 'AI Force' : systemName;
  const optionButtonClassName =
    'auth-page-shell__option-button w-full h-12 flex items-center justify-center !rounded-full transition-colors';
  const primaryButtonClassName =
    'auth-page-shell__primary-button w-full h-12 flex items-center justify-center !rounded-full transition-colors';
  ...
  const tertiaryButtonClassName =
    'auth-page-shell__tertiary-button w-full !rounded-full';
      ...
      <div className='flex flex-col items-center'>
        <div className='w-full max-w-md'>
          <div className='flex items-center justify-center mb-6 gap-2'>
            ...
            <Title heading={3} className='auth-page-shell__brand-title'>
              {brandName}
            </Title>
          </div>

          <Card className='auth-page-shell__card border-0 !rounded-2xl overflow-hidden'>
            <div className='flex justify-center pt-6 pb-2'>
              <Title heading={3} className='auth-page-shell__title'>
                {t('登 录')}
              </Title>
            </div>
              ...
              {!status.self_use_mode_enabled && (
                <div className='mt-6 text-center text-sm'>
                  <Text>
                    ...
                    <Link
                      to='/register'
                      className='auth-page-shell__link font-medium'
                    >
                      {t('注册')}
                    </Link>
                  </Text>
            ...
            <div className='px-2 py-8'>
              {status.passkey_login && passkeySupported && (
                <Button
                  theme='outline'
                  type='tertiary'
                  className={`${optionButtonClassName} mb-4`}
                  icon={<IconKey size='large' />}
                  onClick={handlePasskeyLogin}
                  loading={passkeyLoading}
                >
  ...
  return (
    <div className='auth-page-shell auth-page-shell--marketing relative overflow-hidden flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8'>
      {/* 背景模糊晕染球 */}
      <div
