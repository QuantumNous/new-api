          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 w-full">
            <div className="text-left">
              ...
              <div className="flex flex-col gap-4">
                <a href="https://docs.newapi.ai/wiki/project-introduction/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('关于项目')}</a>
                <a href="https://docs.newapi.ai/support/community-interaction/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('联系我们')}</a>
                <a href="https://docs.newapi.ai/wiki/features-introduction/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('功能特性')}</a>
              </div>
            </div>
            ...
            <div className="text-left">
              ...
              <div className="flex flex-col gap-4">
                <a href="https://docs.newapi.ai/getting-started/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('快速开始')}</a>
                <a href="https://docs.newapi.ai/installation/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('安装指南')}</a>
                <a href="https://docs.newapi.ai/api/" target="_blank" rel="noopener noreferrer" className="!text-semi-color-text-1">{t('API 文档')}</a>
              </div>
            </div>
