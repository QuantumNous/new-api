...
export function Glow({ className, variant, ...props }: GlowProps) {
  return (
    ...
    >
      <div
        className={cn(
          'from-primary/50 to-primary/0 absolute left-1/2 h-[256px] w-[60%] -translate-x-1/2 scale-[2.5] rounded-[50%] bg-radial from-10% to-60% opacity-20 sm:h-[512px] dark:opacity-100',
