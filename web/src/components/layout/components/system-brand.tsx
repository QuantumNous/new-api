  ...
  if (variant === 'inline') {
    return (
      <Link
        ...
        className={cn(
          'text-foreground inline-flex h-8 items-center gap-2 rounded-xl border border-primary/10 bg-primary/6 px-2 text-sm font-bold transition-colors outline-none select-none',
