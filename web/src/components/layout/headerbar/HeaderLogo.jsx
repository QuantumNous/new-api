...
const HeaderLogo = ({
  ...
  return (
    <Link to='/' className='group flex items-center gap-3 min-w-0 text-inherit no-underline'>
      <div className='relative h-8 w-8 shrink-0 overflow-hidden rounded-full shadow-[0_12px_28px_rgba(var(--semi-blue-5),0.22)]'>
      ...
      <div className='hidden min-w-0 md:flex md:flex-col md:items-start md:gap-0.5'>
        <div className='flex items-center gap-2 min-w-0'>
          ...
          >
            <Typography.Title
              heading={4}
              className='!mb-0 !text-lg !font-black tracking-[0.08em]'
            >
              {systemName}
            </Typography.Title>
          </SkeletonWrapper>
