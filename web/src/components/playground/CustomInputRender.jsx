...
const CustomInputRender = (props) => {
  ...
  const styledClearNode = clearContextNode
    ? React.cloneElement(clearContextNode, {
        className: `playground-input-clear-button !rounded-full flex-shrink-0 transition-all ${clearContextNode.props.className || ''}`,
        style: {
  ...
  const styledSendNode = React.cloneElement(sendNode, {
    className: `playground-input-send-button !rounded-full flex-shrink-0 transition-all ${sendNode.props.className || ''}`,
    style: {
  ...
  return (
    <div className='playground-input-wrap p-2 sm:p-4' ref={containerRef}>
      <div
