...
const CustomOAuthSetting = ({ serverAddress }) => {
  ...
  const usesMappedRoleGroup =
    isOAuthCode || isJWTDirect || isTrustedHeader || isCAS;
        ...
        <Banner
          ...
          description={
            <>
              ...
              <br />
              {t(
                '浏览器回调 URL 用于 OAuth Code Flow 与 CAS 协议；CAS 模式会先走 /api/auth/external/{slug}/cas/start，再在回调阶段完成验票与登录',
              )}
            </>
          }
            ...
            >
              <Space spacing={8} align='center'>
                ...
                <Switch
                  ...
                  id={enabledSwitchId}
                  aria-labelledby={enabledSwitchLabelId}
                />
            ...
            >
              ...
              <Row gutter={16}>
                ...
                <Col
                  xs={24}
                  md={6}
                  className='custom-oauth-provider-icon-preview-col'
                  style={{ display: 'flex', alignItems: 'flex-end' }}
                >
                  <div
                    className='custom-oauth-provider-icon-preview'
                    style={{
                      width: '100%',
                      minHeight: 74,
                      ...
                      <Form.Select
                        ...
                        onChange={(value) => {
                          const nextValues = {
                            ...
                            authorization_service_field:
                              formValues.authorization_service_field ||
                              'service',
                            ticket_exchange_method:
                              formValues.ticket_exchange_method || 'GET',
                            ticket_exchange_payload_mode:
                              formValues.ticket_exchange_payload_mode ||
                              'query',
                            ticket_exchange_ticket_field:
                              formValues.ticket_exchange_ticket_field ||
                              'ticket',
                          };
                      ...
                      <Form.Input
                        ...
                        extraText={
                          isJWTUserInfoMode
                            ...
                            : isJWTTicketValidateMode
                              ? t(
                                  'ticket_validate 模式下可留空，不参与本地验签',
                                )
                              : ''
                        }
                      />
                      ...
                      <Row gutter={16}>
                        <Col xs={24} md={12}>
                          <Form.TextArea
                            ...
                            value={
                              formValues.ticket_exchange_extra_params || ''
                            }
                            onChange={(value) =>
                              mergeFormValues({
