...
const PersonalSetting = () => {
  ...
  return (
    <div
      className='personal-settings-page wallet-page console-finance-command-page console-command-center topup-command-center w-full relative min-h-screen lg:min-h-0 mt-[60px]'
      style={{
        width: '100%',
        minHeight: '100vh',
      }}
