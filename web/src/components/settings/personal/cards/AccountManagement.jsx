  ...
  const renderAccountInfo = (accountId, label) => {
    ...
    return (
      <Popover content={popContent} position='top' trigger='hover'>
        <span className='block max-w-full truncate text-muted hover:text-primary cursor-pointer'>
          {accountId}
        </span>
      </Popover>
    );
              ...
              <Card className='!rounded-xl'>
                <div className='flex items-center justify-between gap-3'>
                  <div className='flex items-center flex-1 min-w-0'>
                    <div className='w-10 h-10 rounded-full bg-surface-secondary flex items-center justify-center mr-3 flex-shrink-0'>
                      <IconMail
                        size='default'
              ...
              <Space vertical className='w-full'>
                  ...
                  <div className='flex flex-col sm:flex-row items-start sm:justify-between gap-4'>
                    <div className='flex items-start w-full sm:w-auto'>
                      <div className='w-12 h-12 rounded-full bg-surface-secondary flex items-center justify-center mr-4 flex-shrink-0'>
                        <IconKey size='large' className='text-muted' />
                      </div>
                    ...
                    <Button
                      ...
                      className='!bg-foreground/85 hover:!bg-foreground w-full sm:w-auto'
                      icon={<IconKey />}
                    >
                ...
                <Card className='!rounded-xl w-full'>
                  <div className='flex flex-col sm:flex-row items-start sm:justify-between gap-4'>
                    <div className='flex items-start w-full sm:w-auto'>
                      <div className='w-12 h-12 rounded-full bg-surface-secondary flex items-center justify-center mr-4 flex-shrink-0'>
                        <IconLock size='large' className='text-muted' />
                      </div>
                      <div>
                        <Typography.Title heading={6} className='mb-1'>
                          {t('密码管理')}
                ...
                <Card className='!rounded-xl w-full'>
                  <div className='flex flex-col sm:flex-row items-start sm:justify-between gap-4'>
                    <div className='flex items-start w-full sm:w-auto'>
                      <div className='w-12 h-12 rounded-full bg-surface-secondary flex items-center justify-center mr-4 flex-shrink-0'>
                        <IconDelete size='large' className='text-muted' />
                      </div>
                      <div>
                        <Typography.Title
                          heading={6}
                    ...
                    <Button
                      ...
                      className='w-full sm:w-auto !bg-foreground/70 hover:!bg-foreground/85'
                      icon={<IconDelete />}
                    >
                      {t('删除账户')}
                    </Button>
