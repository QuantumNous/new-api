...
const EditChannelModal = (props) => {
  ...
  const renderChannelOption = (renderProps) => {
    ...
    const optionClassName = [
      'flex items-center gap-3 px-3 py-2 transition-all duration-200 rounded-semi-border-radius-medium mx-2 my-1',
      focused && 'bg-semi-color-primary-light-default shadow-sm',
      selected &&
        'bg-semi-color-primary-light-default text-semi-color-primary shadow-lg ring-2 ring-semi-color-primary-light-hover ring-opacity-50',
                      ...
                      {upstreamDetectedModels.length === 0 ? (
                        ...
                        <>
                          <Tooltip
                            position='topLeft'
                            content={
                              <div className='max-w-[calc(var(--na-space-px) * 640)] break-all text-xs leading-5'>
              ...
              <>
                <Spin spinning={loading}>
                  <div className='p-2 space-y-3' ref={formContainerRef}>
                    ...
                    <Card className='na-channel-card'>
                      {/* Header */}
                      ...
                      {isIonetChannel && (
                        <Banner
                          type='info'
                          closeIcon={null}
                          className='mb-4 na-billing-card-soft'
                          description={t(
                            ...
                            <>
                              ...
                              {batch && (
                                <Banner
                                  ...
                                  className='na-billing-card-soft mb-3'
                                />
                              )}
                        ...
                        <>
                          ...
                          {inputs.multi_key_mode === 'polling' && (
                            <Banner
                              ...
                              className='na-billing-card-soft mt-2'
                            />
                          )}
                        </>
                      )}
                    ...
                    {isMobile ? (
                      ...
                      <div
                        className='na-channel-advanced-trigger'
                        style={{
      ...
      <Modal
        title={
          <div className='flex items-center'>
            <div className='na-auth-twofa-icon'>
              <svg
                className='text-semi-color-success'
                fill='currentColor'
                viewBox='0 0 20 20'
              >
                <path
