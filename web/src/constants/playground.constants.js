...
export const API_ENDPOINTS = {
  ...
  IMAGE_ASYNC_GENERATIONS: '/pg/images/async-generations',
  IMAGE_ASYNC_EDITS: '/pg/images/async-edits',
  VIDEO_GENERATIONS: '/pg/video/generations',
  VIDEO_ASYNC_GENERATIONS: '/pg/video/async-generations',
  USER_MODELS: '/api/user/models',
  USER_GROUPS: '/api/user/self/groups',
  CREATIVE_CENTER_HISTORY: '/api/user/self/creative-center/history',
  CREATIVE_CENTER_IMAGE_UPLOAD_CONFIG:
