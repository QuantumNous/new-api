  ...
  return (
    <div className='flex flex-col space-y-4 sm:space-y-6'>
      ...
      <div className='order-1 space-y-3'>
        <div>
          <h4 className='text-sm font-medium'>{t('Notification Channel')}</h4>
          <p className='text-muted-foreground mt-1 text-xs'>
            {t('Choose how enabled notification events should be delivered.')}
          </p>
        </div>
      ...
      <div className='order-5 space-y-3'>
        <div>
          <h4 className='text-sm font-medium'>{t('Account Behavior')}</h4>
          <p className='text-muted-foreground mt-1 text-xs'>
