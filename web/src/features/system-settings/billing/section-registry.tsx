    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          DogPayEnabled: settings.DogPayEnabled ?? false,
          DogPayBaseUrl: settings.DogPayBaseUrl ?? '',
          DogPayAppId: settings.DogPayAppId ?? '',
          DogPaySecret: settings.DogPaySecret ?? '',
          DogPayPrice: settings.DogPayPrice ?? 1,
          DogPayMinTopUp: settings.DogPayMinTopUp ?? 0.01,
          DogPayFee: settings.DogPayFee ?? 0,
