  ...
  useEffect(() => {
    ...
    if (editData) {
      form.reset({
        ...
        audioCacheRatio: editData.audioCacheRatio || '',
        imageCacheRatio: editData.imageCacheRatio || '',
  ...
  const warnings = useMemo(() => {
    ...
    const hasConflict =
      ...
      [
        ...
        editData.cacheRatio,
        editData.audioCacheRatio,
        editData.imageCacheRatio,
  ...
  const buildSubmitData = useCallback(
    (values: ModelPricingFormValues) => {
      const data: ModelRatioData = {
        ...
        audioCacheRatio: values.audioCacheRatio || '',
        imageCacheRatio: values.imageCacheRatio || '',
