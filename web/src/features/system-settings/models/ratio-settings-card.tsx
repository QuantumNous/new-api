...
const createModelSchema = (t: Translate) =>
  z.object({
    ...
    AudioCacheRatio: createJsonStringField(t),
    ImageCacheRatio: createJsonStringField(t),
...
export function RatioSettingsCard({
  ...
  const modelNormalizedDefaults = useRef({
    ...
    AudioCacheRatio: normalizeJsonString(modelDefaults.AudioCacheRatio),
    ImageCacheRatio: normalizeJsonString(modelDefaults.ImageCacheRatio),
  ...
  const modelForm = useForm<ModelFormValues>({
    ...
    defaultValues: {
      ...
      AudioCacheRatio: formatJsonForTextarea(modelDefaults.AudioCacheRatio),
      ImageCacheRatio: formatJsonForTextarea(modelDefaults.ImageCacheRatio),
  ...
  const saveModelRatios = useCallback(
    async (values: ModelFormValues) => {
      const normalized = {
        ...
        AudioCacheRatio: normalizeJsonString(values.AudioCacheRatio),
        ImageCacheRatio: normalizeJsonString(values.ImageCacheRatio),
    ...
    return (
      <UpstreamRatioSync
        modelRatios={{
          ...
          AudioCacheRatio: modelDefaults.AudioCacheRatio,
          ImageCacheRatio: modelDefaults.ImageCacheRatio,
