...
function parseLobeIcon(iconName, size) {
  if (typeof iconName === 'string') iconName = iconName.trim();
  if (!iconName) {
    return { IconComponent: null, props: {}, fallbackText: '?' };
  }

  const segments = String(iconName).split('.');
  const baseKey = segments[0];
  const BaseIcon = LOBE_ICON_REGISTRY[baseKey];
  ...
  return {
    IconComponent,
    props,
    fallbackText: String(iconName).charAt(0).toUpperCase() || '?',
  };
}
...
export const getModelCategories = (() => {
  ...
  return (t) => {
    ...
    categoriesCache = {
      ...
      anthropic: {
        label: 'Anthropic',
        icon: getLobeHubIcon('Claude.Color'),
        filter: (model) => model.model_name.toLowerCase().includes('claude'),
      },
      gemini: {
        label: 'Gemini',
        icon: getLobeHubIcon('Gemini.Color'),
        filter: (model) =>
      ...
      zhipu: {
        label: t('智谱'),
        icon: getLobeHubIcon('Zhipu.Color'),
        filter: (model) =>
...
export function getChannelIcon(channelType) {
  ...
  switch (channelType) {
    ...
    case 3: // Azure OpenAI
    case 57: // Codex
      return getLobeHubIcon('OpenAI', iconSize);
    case 2: // Midjourney Proxy
    case 5: // Midjourney Proxy Plus
      return getLobeHubIcon('Midjourney', iconSize);
    case 36: // Suno API
      return getLobeHubIcon('Suno', iconSize);
    case 4: // Ollama
      return getLobeHubIcon('Ollama', iconSize);
    case 14: // Anthropic Claude
    case 33: // AWS Claude
      return getLobeHubIcon('Claude.Color', iconSize);
    case 41: // Vertex AI
      return getLobeHubIcon('Gemini.Color', iconSize);
    case 34: // Cohere
      return getLobeHubIcon('Cohere.Color', iconSize);
    case 39: // Cloudflare
      return getLobeHubIcon('Cloudflare.Color', iconSize);
    case 43: // DeepSeek
      return getLobeHubIcon('DeepSeek.Color', iconSize);
    case 15: // 百度文心千帆
    case 46: // 百度文心千帆V2
      return getLobeHubIcon('Wenxin.Color', iconSize);
    case 17: // 阿里通义千问
      return getLobeHubIcon('Qwen.Color', iconSize);
    case 18: // 讯飞星火认知
      return getLobeHubIcon('Spark.Color', iconSize);
    case 16: // 智谱 ChatGLM
    case 26: // 智谱 GLM-4V
      return getLobeHubIcon('Zhipu.Color', iconSize);
    case 24: // Google Gemini
    case 11: // Google PaLM2
      return getLobeHubIcon('Gemini.Color', iconSize);
    case 47: // Xinference
      return getLobeHubIcon('Xinference.Color', iconSize);
    case 25: // Moonshot
      return getLobeHubIcon('Moonshot', iconSize);
    case 27: // Perplexity
      return getLobeHubIcon('Perplexity.Color', iconSize);
    case 20: // OpenRouter
      return getLobeHubIcon('OpenRouter', iconSize);
    case 19: // 360 智脑
      return getLobeHubIcon('Ai360.Color', iconSize);
    case 23: // 腾讯混元
      return getLobeHubIcon('Hunyuan.Color', iconSize);
    case 31: // 零一万物
      return getLobeHubIcon('Yi.Color', iconSize);
    case 35: // MiniMax
      return getLobeHubIcon('Minimax.Color', iconSize);
    case 37: // Dify
      return getLobeHubIcon('Dify.Color', iconSize);
    case 38: // Jina
      return getLobeHubIcon('Jina', iconSize);
    case 40: // SiliconCloud
      return getLobeHubIcon('SiliconCloud.Color', iconSize);
    case 42: // Mistral AI
      return getLobeHubIcon('Mistral.Color', iconSize);
    case 45: // 字节火山方舟、豆包通用
      return getLobeHubIcon('Doubao.Color', iconSize);
    case 48: // xAI
      return getLobeHubIcon('XAI', iconSize);
    case 49: // Coze
      return getLobeHubIcon('Coze', iconSize);
    case 50: // 可灵 Kling
      return getLobeHubIcon('Kling.Color', iconSize);
    case 51: // 即梦 Jimeng
      return getLobeHubIcon('Jimeng.Color', iconSize);
    case 54: // 豆包视频 Doubao Video
      return getLobeHubIcon('Doubao.Color', iconSize);
    case 56: // Replicate
      return getLobeHubIcon('Replicate', iconSize);
    case 8: // 自定义渠道
    case 22: // 知识库：FastGPT
      return getLobeHubIcon('FastGPT.Color', iconSize);
...
export function getLobeHubIcon(iconName, size = 14) {
  const parsed = parseLobeIcon(iconName, size);
  if (!parsed.IconComponent) {
    return <Avatar size='extra-extra-small'>{parsed.fallbackText}</Avatar>;
  }
  return <parsed.IconComponent {...parsed.props} />;
}
