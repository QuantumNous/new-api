...
const URL_TO_CONFIG_MAP: Record<string, { section: string; module: string }> = {
  ...
  '/usage-logs?section=common': { section: 'console', module: 'log' },
  '/usage-logs?section=drawing': { section: 'console', module: 'midjourney' },
  '/usage-logs?section=task': { section: 'console', module: 'task' },
  '/wallet': { section: 'personal', module: 'topup' },
  '/profile': { section: 'personal', module: 'personal' },
  '/channels': { section: 'admin', module: 'channel' },
  '/models': { section: 'admin', module: 'models' },
  '/models?section=metadata': { section: 'admin', module: 'models' },
  '/models?section=deployments': { section: 'admin', module: 'models' },
