...
export const STATIC_I18N_KEYS = [
  ...
  // AI drawing batch labels and server error messages
  'Number of images',
  'Enter a whole number from 1 to {{max}}',
  'Leave blank for 1 image. Images expire 2 hours after generation.',
  'Product image set (optional)',
  'Split your brief into separate images. Review the plan before generating. Text model usage is billed separately.',
  'Ask the administrator to configure the image planning model',
  'Split into image tasks',
  'Image {{number}} title',
  'Image {{number}} prompt',
  'Use the same prompt for all images',
  'Planning failed',
  'Close older drawing tabs to clear their cached images',
  'Result uncertain',
  ...
  'Reload image',
  'Recover image',
  'Generating this image again may incur another charge. Continue?',
  'Expires at {{time}}',
  'The model returned a different aspect ratio. Actual dimensions are shown above.',
  'Download available ({{count}})',
  '{{done}} / {{total}} images ready',
  'Recent image batches',
  'Images are kept for 2 hours. Download them before they expire.',
  'AI drawing batches',
  'Image planning model',
  'An existing text model ID',
  'Optional. Use an existing text model available to the selected user group. Planning uses the normal billing rules.',
  ...
  'Generation interrupted; check usage before retrying',
  'Image generation failed; see usage log',
  'Reference image unavailable or ratio unsupported',
  'Model rejected the prompt, ratio or image parameters',
  'Model or group access denied',
  'Insufficient quota',
  'Rate limit reached; retry later',
  'Image received but not saved; recover without generating again',
  'This model does not support the exact selected ratio',
  'Unsupported aspect ratio',
  'Image count exceeds the allowed range',
  'Plan must contain exactly the requested image count',
  'Too many pending images; wait for the current batch',
  'Submission already used or too many pending images',
  'Retry limit reached',
  'Only failed images can be regenerated',
  'Image recovery is unavailable, expired or busy',
  'Planning is busy; try again later',
  'Planning model request failed; check model configuration and usage log',
  'Planning model did not return the requested number of valid image tasks',
  'Planning model returned an invalid response',
  'Invalid or oversized drawing request',
  'Unable to save reference image',
  'Unable to load drawing tasks',
  'Only PNG, JPEG and WebP images are supported',
  'Image exceeds the size limit',
  'Image dimensions exceed the limit',
  'Image is not ready',
  'No unexpired images to download',
  'Archive is too large; download images individually',
  'Retry may incur another charge; confirmation required',
  'Prompt is required and must be within 16000 bytes',
  'Image recovery is busy; try again later',
  'Invalid image plan',
  // Saved drawing template messages
  'Prompt templates',
  'Save as template',
  ...
  'Product image template text',
  'Unable to load prompt templates',
  'Invalid prompt template',
  'Prompt template not found',
  'Unable to save prompt template',
  'Unable to delete prompt template',
  'You can save up to 20 prompt templates',
  'Enter a template name and prompt within the allowed length',
  // Agent permissions and pricing
  'Agent center',
  'Agent access',
  'Enable agent access',
  ...
  'My customers',
  'Paying customers',
  'Customer top-up total',
  'My registration link',
  'Customer image price',
  ...
  'No customers yet',
  'Agent access is not enabled',
  'Unable to load agent data',
  'Image price must be between 0.02 and 0.06 CNY',
  'Agent settings changed; reload before saving',
  'Customer or agent not found',
  'Invalid agent price request',
  'Invalid agent settings',
  'Invalid pagination',
  'Invalid customer ID',
  'Your price: ¥{{price}} per image',
  'Per image',
  'Image price changed; review the new price and submit again',
  'Unable to determine the image price',
  'Unable to save the image price',
  'Unable to read the locked image price',
] as const
