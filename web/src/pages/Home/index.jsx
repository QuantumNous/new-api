...
const Home = () => {
  ...
  return (
    <div className='w-full overflow-x-hidden min-h-full flex flex-col'>
      <NoticeModal
      ...
      {homePageContentLoaded && homePageContent === '' ? (
        <div className='w-full overflow-x-hidden flex-1 flex flex-col'>
          ...
          <div className='w-full min-h-[500px] md:min-h-[600px] lg:min-h-[700px] relative overflow-x-hidden'>
            ...
            <div className='flex items-center justify-center h-full px-4 py-20 md:py-24 lg:py-20 mt-10'>
              {/* 居中内容区 */}
