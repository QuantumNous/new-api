        ...
        <Row gutter={16}>
          <Col xs={24} sm={16}>
            <Form.TextArea
              ...
              extraText={
                t('分组倍率设置，可以在此处新增分组或修改现有分组的倍率，格式为 JSON 字符串，例如：') +
                '{"vip": 0.5, "test": 1}' +
                t('，表示 vip 分组的倍率为 0.5，test 分组的倍率为 1')
              }
              field={'GroupRatio'}
        ...
        <Row gutter={16}>
          <Col xs={24} sm={16}>
            <Form.TextArea
              ...
              extraText={
                t('用户新建令牌时可选的分组，格式为 JSON 字符串，例如：') +
                '{"vip": "VIP 用户", "test": "测试"}' +
                t('，表示用户可以选择 vip 分组和 test 分组')
              }
        ...
        <Row gutter={16}>
          <Col xs={24} sm={16}>
            <Form.TextArea
              ...
              extraText={
                t('键为分组名称，值为另一个 JSON 对象，键为分组名称，值为该分组的用户的特殊分组倍率，例如：') +
                '{"vip": {"default": 0.5, "test": 1}}' +
                t('，表示 vip 分组的用户在使用default分组的令牌时倍率为0.5，使用test分组时倍率为1')
              }
