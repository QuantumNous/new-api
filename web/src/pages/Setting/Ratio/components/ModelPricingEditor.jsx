...
import { Banner, Checkbox, Empty, Modal, Radio, RadioGroup, Space, Table, Tag, Typography } from '@/components/common/ui/HeroCompat';
import {
  IconDelete,
  IconPlus,
  IconSave,
...
const PriceInput = ({
  ...
  <div style={{ marginBottom: 16 }}>
    <div className='mb-1 font-medium text-foreground flex items-center justify-between gap-3'>
      <span>{label}</span>
      {headerAction}
    </div>
    {!hidden ? (
                ...
                {selectedWarnings.length > 0 ? (
                  ...
                  >
                    ...
                    {selectedWarnings.map((warning) => (
                      <div key={warning} className='text-sm text-foreground mb-1'>
                        {warning}
                      </div>
                    ))}
                  </Card>
