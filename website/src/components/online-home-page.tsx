...
export async function OnlineHomePage(props: { locale: Locale }) {
  ...
  return (
    <OnlineStaticShell locale={props.locale} pathname="/">
      <style>{`
        .online-static-page:has(> header.hero.heroUnified) .heroUnified h1.display{max-width:min(100%,720px);font-size:66px;line-height:1;letter-spacing:0;overflow-wrap:anywhere;text-wrap:balance}
        ...
        @media(max-width:1000px){.online-static-page:has(> header.hero.heroUnified) .heroUnified h1.display{font-size:58px;max-width:760px}}
        @media(max-width:620px){.online-static-page:has(> header.hero.heroUnified) .heroUnified h1.display{font-size:40px;line-height:1.04;letter-spacing:0}.online-static-page:has(> header.hero.heroUnified) .heroUnified h1 .price{margin-top:8px}.online-static-page:has(> header.hero.heroUnified) .heroUnified .heroCtas .btn{white-space:normal;text-align:center}}
        @media(max-width:380px){.online-static-page:has(> header.hero.heroUnified) .heroUnified h1.display{font-size:36px}}
