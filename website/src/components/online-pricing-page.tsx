...
export function OnlinePricingPlansSection(props: { locale: Locale }) {
  ...
  return (
    <>
      <style>{`
        .wrap{max-width:var(--fk-site-frame-max-width);margin:0 auto;padding:72px var(--fk-site-gutter)}.wrap>.display{font-size:54px;line-height:1.04;letter-spacing:-1.9px}.wrap>.sub{max-width:860px;font-size:19px;line-height:1.65}.tiers{display:grid;grid-template-columns:repeat(4,1fr);gap:20px;margin:46px 0 30px}.tier{background:#fff;border:1.5px solid var(--line);border-radius:20px;padding:32px 27px;position:relative;display:grid;grid-template-rows:auto 66px 58px 48px 1fr;align-content:start}.tier.hot{border-color:var(--violet);box-shadow:0 18px 54px rgba(109,92,255,.16)}.tier .badge{position:absolute;top:-14px;left:24px;background:var(--violet);color:#fff;font-size:12.5px;font-weight:800;padding:6px 14px;border-radius:999px}.tier b{font-size:43px;letter-spacing:-1.6px;font-weight:650;line-height:1}.tier .tname{font-family:var(--disp);font-size:28px;letter-spacing:-.7px;font-weight:700;color:var(--ink)}.tier .taud{font-size:14.5px;color:var(--ink3);margin:5px 0 0;line-height:1.5;min-height:0}.tier .per{font-size:17px;color:var(--ink3);font-weight:650;line-height:1;margin-left:3px}.tier .tprice{min-height:0;display:flex;align-items:baseline;white-space:nowrap}.tier .tcustom{font-size:34px}.tval{background:var(--violet-tint);border-radius:14px;padding:18px 17px;margin:16px 0 20px}.tglabel{font-family:var(--mono);font-size:11.5px;letter-spacing:.8px;color:var(--ink3);font-weight:700;display:block;margin-bottom:6px;text-transform:uppercase}.tgmain{color:var(--violet-deep);font-weight:850;font-size:16.5px;letter-spacing:-.2px}.tgsub{font-size:13.5px;color:var(--ink2);margin-top:5px;line-height:1.55}.tdiv{border-top:1px dashed #D8D0F2;margin:15px 0}.tcta{margin:0;text-align:center;display:flex;align-items:center;justify-content:center;width:100%;height:48px;font-size:15.5px;line-height:1.15}.tier p{font-size:15px;color:var(--ink2);line-height:1.65}.pay{background:#fff;border:1.5px solid var(--line);border-radius:20px;padding:28px;display:flex;align-items:center;column-gap:30px;row-gap:14px;flex-wrap:wrap}.payLabel{font-weight:800;font-size:14.5px}.pm{display:inline-flex;align-items:center;gap:6px;min-height:48px;border:0;border-radius:0;padding:0;font:inherit;font-weight:750;font-size:14.5px;line-height:1;white-space:nowrap;background:transparent;color:var(--ink)}.pmLogo{display:grid;place-items:center;flex:none;height:28px;overflow:hidden}.pmLogo.card{width:32px;border:1px solid #E2DEE8;border-radius:8px;background:#FAFAF6;color:#111827}.pmLogo.pix{width:44px}.pmLogo.upi{width:44px}.pmLogo.alipay{width:50px;color:#111827}.pmLogo.usdc{width:28px}.pmLogo img,.pmLogo svg{display:block;width:100%;height:100%;object-fit:contain}.pmText{color:var(--ink)}.local{font-size:14.5px;color:var(--ink3);margin-top:16px;line-height:1.55}.curr{position:absolute;top:24px;right:24px;font-family:var(--mono);font-size:13px;color:var(--ink3)}
      `}</style>
      <div className="wrap">
