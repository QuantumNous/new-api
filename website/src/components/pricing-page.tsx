...
const PRICING_UI_COPY: Record<Locale, PricingPageLocalizedUiCopy> = {
  en: {
    pricingHeroTitle: "Top up & get bonus credit — up to 33% off",
    pricingHeroDescription: "Pay $10, get $13. Pay $20, get $28. Pay $200, get $300 — same official models, bonus credited instantly, forever.",
  ...
  zh: {
    pricingHeroTitle: "充值即送额度，最低至 6.7 折",
    pricingHeroDescription: "充 $10 到账 $13，充 $20 到账 $28，充 $200 到账 $300 —— 同款官方模型，赠送即时到账，永久有效。",
    modelsEyebrow: "模型",
  ...
  es: {
    pricingHeroTitle: "Recarga y recibe crédito extra — hasta 33% menos",
    pricingHeroDescription: "Paga $10 y recibe $13. Paga $20 y recibe $28. Paga $200 y recibe $300 — mismos modelos oficiales, bono acreditado al instante, para siempre.",
  ...
  fr: {
    pricingHeroTitle: "Rechargez et recevez du crédit bonus — jusqu’à 33 % de moins",
    pricingHeroDescription: "Payez 10 $, recevez 13 $. Payez 20 $, recevez 28 $. Payez 200 $, recevez 300 $ — mêmes modèles officiels, bonus crédité instantanément, pour toujours.",
  ...
  pt: {
    pricingHeroTitle: "Recarregue e ganhe crédito bônus — até 33% menos",
    pricingHeroDescription: "Pague $10 e receba $13. Pague $20 e receba $28. Pague $200 e receba $300 — mesmos modelos oficiais, bônus creditado na hora, para sempre.",
    modelsEyebrow: "Modelos",
  ...
  ru: {
    pricingHeroTitle: "Пополняйте и получайте бонусный кредит — до 33% дешевле",
    pricingHeroDescription: "Заплатите $10 — получите $13. $20 — $28. $200 — $300. Те же официальные модели, бонус зачисляется мгновенно и навсегда.",
  ...
  ja: {
    pricingHeroTitle: "チャージでボーナス進呈 — 最大33%オフ",
    pricingHeroDescription: "$10 で $13、$20 で $28、$200 で $300。同じ公式モデル、ボーナスは即時付与、期限なし。",
    modelsEyebrow: "モデル",
  ...
  vi: {
    pricingHeroTitle: "Nạp tiền nhận credit thưởng — rẻ hơn tới 33%",
    pricingHeroDescription: "Nạp $10 nhận $13, nạp $20 nhận $28, nạp $200 nhận $300 — cùng model chính thức, credit cộng ngay, vĩnh viễn.",
  ...
  de: {
    pricingHeroTitle: "Aufladen und Bonusguthaben erhalten — bis zu 33% günstiger",
    pricingHeroDescription: "Zahle $10, erhalte $13. Zahle $20, erhalte $28. Zahle $200, erhalte $300 — gleiche offizielle Modelle, Bonus sofort gutgeschrieben, dauerhaft.",
...
const PRICING_FAQS: Record<Locale, PricingFaq[]> = {
  en: [
    { question: "How does the top-up bonus work?", answer: "Every top-up earns bonus credit, forever: +$3 on $10, +$8 on $20, +$100 on $200. The bonus lands in your balance instantly and is spent like normal credit." },
  ...
  zh: [
    { question: "充值赠送是怎么算的？", answer: "每次充值都送额度，永久有效：充 $10 送 $3、充 $20 送 $8、充 $200 送 $100。赠送即时到账，和普通余额一样使用。" },
  ...
  es: [
    { question: "¿Cómo funciona el bono de recarga?", answer: "Cada recarga otorga crédito extra, para siempre: +$3 en $10, +$8 en $20, +$100 en $200. El bono se acredita al instante y se usa como saldo normal." },
  ...
  fr: [
    { question: "Comment fonctionne le bonus de recharge ?", answer: "Chaque recharge offre du crédit bonus, pour toujours : +3 $ sur 10 $, +8 $ sur 20 $, +100 $ sur 200 $. Le bonus est crédité instantanément et se dépense comme un solde normal." },
  ...
  pt: [
    { question: "Como funciona o bônus de recarga?", answer: "Cada recarga rende crédito bônus, para sempre: +$3 em $10, +$8 em $20, +$100 em $200. O bônus cai na hora e é gasto como saldo normal." },
  ...
  ru: [
    { question: "Как работает бонус за пополнение?", answer: "Каждое пополнение даёт бонусный кредит, навсегда: +$3 к $10, +$8 к $20, +$100 к $200. Бонус зачисляется мгновенно и тратится как обычный баланс." },
  ...
  ja: [
    { question: "チャージ特典はどのような仕組みですか？", answer: "チャージのたびにボーナスクレジットを進呈、期限なし：$10 で +$3、$20 で +$8、$200 で +$100。ボーナスは即時付与され、通常の残高と同じように使えます。" },
  ...
  vi: [
    { question: "Thưởng nạp tiền hoạt động thế nào?", answer: "Mỗi lần nạp đều được tặng credit, vĩnh viễn: +$3 khi nạp $10, +$8 khi nạp $20, +$100 khi nạp $200. Credit thưởng cộng ngay và dùng như số dư bình thường." },
  ...
  de: [
    { question: "Wie funktioniert der Aufladebonus?", answer: "Jede Aufladung bringt Bonusguthaben, dauerhaft: +$3 bei $10, +$8 bei $20, +$100 bei $200. Der Bonus wird sofort gutgeschrieben und wie normales Guthaben verbraucht." },
