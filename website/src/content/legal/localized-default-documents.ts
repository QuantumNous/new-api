...
本サービス レベル契約 (「SLA」) は、VOC AI INC (「VOC AI」、「当社」) が提供する flatkey.ai サービスの可用性目標およびサポート プロセスを説明するものです。
...
本 SLA またはサービス インシデントに関するご質問は、support@flatkey.ai までご連絡いただくか、VOC AI INC, 160 E Tasman Drive, Suite 202, San Jose, CA 95134, United States まで書面でご連絡ください。
